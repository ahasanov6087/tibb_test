...
},
{
  ...
  // Yeniler
  {
    condition: "Gecə uşaqda 38,7 qizdirma var. Hürücü öskürəkdən uşaq tez-tez yuxudan oyanır. Nəfəsalmada çətinlik çəkir. Arabir boğulma tutmaları müşahidə olunur. Hürücü öskürək var.",
    questions: [
      {
        question: "Bu hansı xəstəlikdir?",
        options: ["Rinit", "Yalançı inaq", "Həqiqi inaq"],
      ...
      {
        question: "Həkim yardımı göstərilənə qədər tibb bacısı nə etməlidir?",
        options: ["Yayındırıcı terapiya", "Medakamintoz terapiya", "Heçnə etməməlidir"],
        correct: 0
      },
      {
        question: "Hansı üsullarla temperaturu endirmək olar?",
        options: ["Masac etməklə", "Fiziki üsullarla", "Hərarətsalıcılarla"],
        correct: 1
      },
      {
        question: "Xəstəyə nə qədər mayə vermək olar?",
        options: ["Çox miqdarda", "Verilməməlidir", "Məhdud miqdarda"],
        correct: 1
      }
    ]
  ...
  {
    condition: "40 həftəlik hamiləlikdən çəkisi 3160 qram boyu 51 sm olan uşaq doğulub. Uşaq dərhal qışqırmış, əzələ tonusu normaldır. Tam sağlam uşaqdır. Apgar şkalasına görə 8 balla qiymətləndirilmişdir.",
    questions: [
      {
        question: "Bu uşağa xəstəxanada ilk 12 saat ərzində hansı peyvəndlər vurulmalıdır?",
        options: ["VƏP, Hepatit", "Hepatit B OPV", "Hepatit B"],
        correct: 2
      },
      {
        question: "Vaksin vurulandan sonra uşaq nə vaxt yeridilməlidir?",
        options: ["Dərhal sonra", "1 saat sonra", "3 saat sonra"],
        correct: 1
      },
      {
      ...
      {
        question: "Genobloneroyanın profillaktikası nə vaxt aparılır?",
        options: ["İlk 1 saat ərzində", "3 saat sonra", "5 saat sonra"],
        correct: 0
      },
      {
  ...
  },
  {
    ...
    questions: [
      {
        question: "Bu hansı xəstəlikdir?",
        options: ["Dizenteriya", "Salmanelyoz", "Sadə diareya"],
        correct: 0
      },
      {
        question: "Bu necə xəstəlikdir?",
        options: ["Yoluxucu", "Somatik", "Nevroloji"],
        correct: 0
      },
      {
        question: "Bu xəstəlik idarə olunur?",
        options: ["Bəli", "Xeyr", "Qismən idarə olunur"],
        correct: 1
      },
      {
        question: "Bu xəstəliyin peyvəndi hansıdır?",
  ...
  {
    condition: "Doğum evində 34 həftəlik hamiləlikdən çəkisi 1700q, boyu 42 sm olan uşaq doğulmuşdur. Ana Hepatit 1 daşıyıcısıdır. Uşaq apqar şkalası ilə 5 balla qiymətləndirilmişdir.",
    questions: [
      {
        question: "Hepatit B vaksini bu uşağa nə vaxt vurula bilər?",
        options: ["Çəkisi az olduğu üçün bu uşağa peyvənd vurulmur", "İlk 12 saat ərzində", "Ana Hepatit B daşıyıcısı olduğu üçün bu uşağa vaksin vurmaq olmaz"],
      ...
      {
        question: "Hepatit B Baksini hansı nahiyəyə vurulur?",
        options: ["Sol çiyindən iki barmaq aşağı dərialtı", "Budun ön lateral hissəsinə əzələdaxili", "Sağ çiyindən aşağı dəri içinə"],
        correct: 1
      },
      {
  ...
  {
    condition: "Xəstə 38 yaşlı kişidir. Qarınüstü (epiqastral) nahiyədə kəskin ağrıdan, ürəkbulanma və qusmadan şikayətlənir. Son 3 ildə müntəzəm olaraq ağrılar baş verir. Birgün əvvəlci qida qəbulundan sonra ağrılar artmış, qusma baş vermişdir. Qusmadan sonra ağrı sakitləşmişdir. Səhəryenidən ağrılar artmış, qusmuş, qəhvə xıltı şəklində qusuntu kütləsi gəlmişdir.",
    questions: [
      {
        question: "Nədən şübhələnirsiniz?",
        options: ["Kəskin enterit", "Mədə xorası", "Qida borusunun divertikulu"],
  ...
  {
    condition: "Uşağın 7 yaşı vardır. Bağçaya gedir. 3 gündür ki xəstələnib. Gecələr temperaturu yüksək olur. İştahası pisdir, baş ağrısı, ürəkbulanma və qarında ağrılardan şikayət edir. Sidiyə tez-tez gedir, sidiyi tünd və kəskin iylidir. Müayinə zamam dərisi solğundur, dili ərplidir, əsməyi qızarıb. Qarında ağrı var, Pasternatski simptomu müsbətdir. Nəcis ifrazı normaldır.",
    questions: [
      {
        question: "Uşaqda hansı xəstəlik ola bilər?",
        options: ["Pielonefrit", "Qida zəhərlənməsi", "Qlomerulonefrit"],
  ...
  {
    condition: "Xəstə qadındır, 41 yaşı var. Döş sümüyü arxasında sıxıcı, təzyiq edici ağrılardan, ağrının sol qola, sol çiyinə yayılmasından, başgicəllənmədən şikayət edir. Ağrılar 5-ci mərtəbəyə ağır zənbillə piyada qalxandan sonra başlayıb. Əvvəllər də ürək nahiyəsində qısa müddətli ağrılar olub, lakin əhəmiyyət verməyib, həkimə müraciət etməyib. Nitroqliserin qəbulundan sonra ağrılar keçib. Obyektiv olaraq vəziyyəti kafidir, dərialtı piy təbəqəsi qalındır. Tənəffüsün sayı 1 dəqiqədə 16, nəbz-92, A/T - 130/90 mm c.süt, W - 36,70C-dir.",
    questions: [
      {
        question: "Nədən şübhələnirsiniz?",
        options: ["Stenokardiyə", "Ürək astması", "Miokard infarktı"],
        correct: 0
      },
      {
        question: "Ürək nahiyəsinə hansını qoymaq məqsədə uyğundur?",
        options: ["Banka", "Xardal yaxması", "Soyuq kompress"],
        correct: 1
      },
      {
      ...
      {
        question: "Tibb bacısının sonrakı taktikası:",
        options: ["Ərazi üzrə poliklinika kardioloqunun müayinəsinə göndərmək və ya təcili yardım maşını ilə tez bir zaman xəstəxanaya çatdırmaq", "Xəstəni evdə saxlayıb, hər gün Analqin və Dimedrol vurmağı məsləhət vermək", "Xəstəni evdə saxlayıb, məsləhət vermək"],
        correct: 0
      }
    ]
  },
  {
    condition: "Xəstə qadındır, 55 yaşı var. Kəskin baş ağrısı, ürəkbulanma, başgicəllənmə, qulaqlarda küy, göz önündə ulduz sayrışması şikayətləri var. Son illər vaxtaşırı baş ağrıları olmuş, lakin əhəmiyyət verməmiş, həkimə müraciət etməmişdir. Burundan qanaxma müşahidə olunub. Obyektiv olaraq vəziyyəti orta ağırdı, nəbz gərgin, 1 dəqiqədə 92, A/T-200/10 mm c.süt.",
    questions: [
      {
        question: "Nədən şübhələnirsiniz?",
        options: ["Anemiya", "Burun qanaxması", "Hipertonik kriz"],
  ...
  {
    condition: "19 yaşı xəstənin yüksək temperatur, diz, topuq, dirsək oynaqlarında ağrı şikayətləri var. Bir gün əvvəl qəflətən temperaturu 39 dərəcə C-yə yüksəlmiş və oynaqlan ağrımağa başlamışdır. Anamnezində 2 həftə əvvəl angina keçirdiyini söyləyir. Obyektiv olaraq vəziyyəti orta ağırdır, bədən temperaturu 39-C-dir. Diz oynağı nahiyəsində şişkinlik, qızartı, hərəkət zamanı ağrı müşahidə olunur. Nəbz 1 dəqiqədə 115, A/T - 110/70 mm c.süt. Ağız boşluğunda kariyesli dişlər, badamcıqların böyüdüyü görünür.",
    questions: [
      {
        question: "Nədən şübhələnirsiniz?",
        options: ["Revmatoid artrit", "Artroz", "Hemorragikvaskulit"],
        correct: 0
      },
      {
        question: "Diz oynağına nə etmək olar?",
      ...
      {
        question: "Qizdırmanı aşağı salmaq üçün nə etmək olar?",
        options: ["Bədənini bürümək", "Bədənini 40 dərəcəli su ilə silmək", "Xəstənin alnına soyuq kompres qoymaq"],
        correct: 2
      },
      {
        question: "Xəstəyə steroid preparatlan necə vermək lazımdır?",
        options: ["Xüsusi sxem üzrə", "Gündə 3 dəfə yeməkdən əvvəl", "Həftədə 1 dəfə"],
        correct: 0
      },
      {
        question: "Tibb bacısının sonrakı taktikası necə olmalıdır?",
        options: ["Həkim - revmatoloqa yönləndirmək", "Həkim - travmatoloqa yönləndirmək", "Həkim - infeksionistə yönləndirmək"],
        correct: 0
      }
    ]
  },
  {
    condition: "Ananın sözlərinə görə 5 yaşlı uşaq gecəni narahat yatır, ağzından su axır, anus dəliyi ətrafında qaşınma, göbək ətrafında ağrılar, ümumi narahatlıq hissi, iştahasızlıq müşahidə olunur. Obyektiv olaraq çəki itkisi, dəri örtüklərinin solğunluğu, anus dəliyi ətrafında ekzematoz zədələnmələr nəzərə çarpır. Sahə həkimi ümumi müayinədən sonra tibb bacısına anaya tövsiyələriniverməyi və anus dəliyindən yaxma götürmək üçün uşağı hazırlamaq qaydalarını öyrətməyi tapşırdı.",
    questions: [
      {
        question: "Hansı xəstəlikdən şübhələnmək olar?",
        options: ["Xolesistit", "Qastrit", "Enterbioz"],
        correct: 2
      },
      {
        question: "Tibb bacısı anaya hansı məsləhəti verə bilər?",
      ...
      {
        question: "Helmiztoz diaqnozu təsdiq edilmiş uşaqlar uşaq müəssisəsinə gedə bilərmi?",
        options: ["Karantin elan edilməlidir", "Gedə bilər", "Yataqxanada müalicə olunmalıdır"],
        correct: 1
      }
    ]
  },
  {
    condition: "Ana 10 yaşlı uşağı ilə poliklinikaya müraciət edib. Uşaq ürək nahiyyəsində ağrılar, ağırlıq hissi, tez yorulma, təngnəfəslik, iri oynaqlarda uçucu xarakter daşıyan ağrılardan şikayət edir. Anamnezdə ildə 4-5 dəfə yüksək temperaturla müşayiət olunan angina qeyd olunur. Obyektiv olaraq uşaqda süstlük, dəri örtüklərinin avazıması, oynaq ətrafında şişkinlik, xırda səpgilər müşahidə edilir. Temperatur 37,80C dir. UDS (ürək döyüntülərinin dəqiqəlik sayı) 80, TS (tənəffüsün dəqiqəlik sayı) 21 dir. Müayinədən sonra həkim müalicə təyin edib və tibb bacısına Bisillin terapiyasını aparmağı tapşırıb.",
    questions: [
      {
        question: "Hansı xəstəlikdən şübhələnmək olar?",
        options: ["Helmintoz", "Revmatizm", "Qastrit"],
      ...
      {
        question: "Həkim gələnə kimi tibb bacısı nə etməlidir?",
        options: ["Xəstənin temperaturunu, nəbzini, tənəffüsünü saymalı", "Xəstəyə müalicə təyin etməli", "Uşağın boğazını silməlidir"],
        correct: 0
      },
      {
        question: "Bisillin-5-in vurulma qaydası necədir?",
        options: ["8 həftə, həftədə 1 dəfə", "Günaşırı, 2 həftə ərzində", "İlboyu, isti aylar istisna olmaqla, əzələdaxili, ayda bir dəfə"],
        correct: 2
      },
      {
        question: "Bədən temperaturu 37,8 OC olduqda, fiziki üsullarla endirməyə ehtiyac varmı?",
        options: ["Bəli", "Xeyr", "Litik qarışıq vurmaq lazımdır"],
        correct: 1
      },
      {
  ...
  {
    condition: "Ana 5 yaşlı oğlu ilə poliklinikaya müraciət edib. Ana uşağın tez yorulmasından, süstlükdən, halsızlıqdan şikayət edir. İştahasının yüksək olmağına baxmayaraq, çəki azlığı müşahidə olunur, çox miqdarda su qəbul edir və tez-tez sidiyə gedir, gecə gündüz enurez qeyd olunur. Obyektiv müayinə zamanı fiziki və zehni qabiliyyətin zəifləməsi, dəri örtüklərinin quruluğu, polidipsiya, polifagiya, poliuriya aşkar olunmuşdur. Aparılan müayinələrdən sonra həkim xəstəyə insulin təyin edir.",
    questions: [
      {
        question: "Hansı xəstəlikdən şübhələnmək olar?",
        options: ["Revmatizm", "Şəkərli diabet", "Qlomerulonefrit"],
      ...
      {
        question: "İnsulinin vurulma qaydası necədir?",
        options: ["Həkimin təyinatına uyğun, birdəfəlik şprislə, hər dəfə yeri dəyişməklə dəri altına yeridilir", "Birdəfəlik şprislə əzələdaxili yeridilir", "Birdəfəlik şprislə dəri içinə yeridilir"],
        correct: 0
      },
      {
        question: "Pəhriz təyin etmək vacibdirmi?",
        options: ["Xeyr Pəhrizə ehtiyac yoxdur", "Bəli Karbohidratların miqdarı qida rasionunda azaldılmalıdır", "Qida rasionunda yalnız zülal çıxarılır"],
        correct: 1
      },
      {
        question: "Sidikdə şəkərin təyini üçün sidik necə yığılmalıdır?",
  ...
  {
    condition: "Ana 4 yaşlı oğlan uşağı ilə həkimə müraciət edib. Uşaqda ümumi zəiflik, iştahasızlıq, baş ağrıları, çeynəmənin ağrılı olması, qulaqarxası nahiyədə şişkinliyin olması müşahidə olunur. Uşaq 3000 q çəki, 52 sm boyla vaxtında doğulub. Doğulan kimi qışqırıb. Biryaşına kimi təbii qidalanıb. Fiziki və psixomotor inkişafı yaşına uyğundur. Profilaktik peyvəndlərdən ana imtina edib. Bağçaya gedir. 2 gündür xəstədir. Obyektiv olaraq uşaqda dəri və selikli qişalar təmizdir, solğun rəngdədir. Temperatur 37,80C-dir, Dili ağ ərpli, əsnəyi təmizdir. Hər iki tərəfdə qulaqarxası nahiyədə şişkinlik var. Şişkinlik yumşaqdır, kənarları hiss olunur. Həmin nahiyədə dərinin rəngi dəyişməyib. Sidik və nəcis ifrazı normaldır. Müayinədən sonra həkim tibb bacısma anaya qulluq qaydaları haqqında məlumat verməyi tapşırır.",
    questions: [
      {
        question: "Uşaqda hansı xəstəlik ola bilər?",
        options: ["Qızılca", "Su çiçəyi", "Epidemik parotit"],
      ...
      {
        question: "Vaksinindən sonra uşaqda hansı immunitet formalaşır?",
        options: ["Süni passiv", "Süni aktiv", "Təbi aktiv"],
        correct: 1
      }
    ]
  },
  {
    condition: "Tibb bacısı raxit diaqnozu ilə müalicə alan 11 aylıq uşağa patronaja gedib. Uşaq süni qidalanır. Temperatur 36.6 C-dir. Obyektiv müayinə edərkən uşaq ağladı və bu zaman qəfildən xırıltılı nəfəsalma fonunda tənəffüsün bir neçə saniyəlik dayanması baş verdi. Uşağın rəngi əvvəl solğunlaşdı, sonra isə sianozlaşdı. Bir neçə dəqiqəyə tutma dərin səsli nəfəsalma ilə qurtardı və uşaq yenidən ağlamağa başladı.",
    questions: [
      {
        question: "Uşaqda nə baş vermişdir?",
        options: ["Spazmofiliya, larinqospazm (səs yarımının spazmı)", "Göy öskürək", "Pnevmoniya"],
        correct: 0
      },
      {
        question: "Tibb bacısı hansı taktikanı seçməlidir?",
        options: ["Xəstəni böyrü üstə uzadaraq, hər tərəfinə isitqac qoymalıdır", "Xəstəni imalə etməlidir", "Xəstəni düz səth yerə uzatmaq, təmiz hava axını ilə təmin etmək, sakitlik vermək və venadaxili kalsium qlükanat yeritməlidir"],
        correct: 2
      },
      {
        question: "Xəstədə bu vəziyyət hansı səbəbdən yarana bilər?",
      ...
      {
        question: "Xəstədə sianozun yaranma səbəbini izah edin",
        options: ["Hipertaniya", "Hipertermiya", "Hipoksiya"],
        correct: 2
      },
      {
        question: "Bu vəziyyətdə xəstəni təmiz hava axını ilə təmin etmək mütləqdirmi?",
  ...
  {
    condition: "Uşağın 6 yaşı var. Uşaq 3200 q çəki, 50 sm boyla vaxtında doğulub. 3 yaşından bağçaya təbii qidalanmışdır. Profilaktik peyvəndlərini vaxtında almışdır. Məktəbə getməyə hazırlaşır. Bağçanın tibb bacısı həkimin müayinəsinə hazırlıq məqsədilə uşağın antropometriyanı aparmışdır. Sahə həkimi müayinədən sonra Milli Peyvənd təqviminə uyğun QPM peyvəndinin aparılması üçün uşağı vaksin otağına göndərir.",
    questions: [
      {
        question: "Normada uşağın çəkisi nə qədər olmalıdır?",
        options: ["22kq", "30kq", "35kq"],
        correct: 0
      },
      {
        question: "Boyu nə qədər olmalıdır?",
        options: ["80 sm", "112sm", "120sm"],
        correct: 1
      },
      {
        question: "6 yaşında uşağa hansı peyvəndlər olunmalıdır?",
      ...
      {
        question: "QPM vaksini hansı nahiyəyə olunmalıdır?",
        options: ["Bazunun bayır orta nahiyəsinə dərialtı vurulur", "Budun ön lateral nahiyəsinə vurulur", "Saidin içəri səthinə dəriiçinə vurulur"],
        correct: 1
      },
      {
        question: "QPM vaksini uşağı hansı xəstəlikdən qoruyur?",
  ...
  {
    condition: "Uşaq 7 günlükdür, 1-ci hamiləlikdəndir. Hamiləlik və doğuş normal keçmişdir. Doğularkən çəkisi 2800 q, boyu 48 sm olmuşdur. Ana südü ilə qidalanır. Göbək qalığı 4cü gün düşmüşdür. Həmin gün doğum evindən evə buraxılmışdır. Uşağın göbəyində şişkinlik və ifrazat olduğu üçün tibb bacıs hər gün patronaja gedir. Ana uşağın pis əmməsindən və narahat olmasından şikayət edir. Obyekti müayinə zamanı uşağın temperaturu 37,80dir. Göbəyi şişkindir, göbəkətrafı dəri qızarıb, ağrılıdır. Döşü tutmur. Dəri və görünən selili qişalar təmizdir. sidik və nəcis ifrazı normaldır.",
    questions: [
      {
        question: "Hansı xəstəlikdən şübhələnmək olar?",
        options: ["Omfolit", "Qarında köp var", "Otit"],
      ...
      {
        question: "Tibb bacısı nə etməlidir?",
        options: ["Uşağın göbəyini dezinfeksiyaedici məhlullarla işləyir, steril salfet qoyur. Həkimə məlumat verməlidir.", "Tibb bacısı anaya tövsiyə edir ki, uşağa şüyüd suyu versin, qarnını masaj etsin isti saxlasın.", "Qarnını masaj etməlidir."],
        correct: 0
      },
      {
        question: "Xəstəliyin ağırlaşması nə ola bilər?",
        options: ["Sepsis", "Kəskin qarın", "Pnevmoniya"],
        correct: 0
      },
      {
        question: "Uşağa BGC və OPV peyvəndlərini etmək olarmı?",
        options: ["Xeyr, temperatur olduğu üçün peyvənd aparmaq əks göstərişdir", "Bəli, profilaktik peyvənd təqviminə uyğun peyvəndlər aparılmalıdır", "Yalnız perora OPV vaksini vermək olar"],
        correct: 0
      }
    ]
  },
  {
    condition: "Uşağın 6 yaşı var. Profilaktik peyvəndləri vaxtında almışdır. 3 yaşından bağçaya gedir. Heç bir infeksion xəstəlik keçirməmişdir. Tez-tez angina ilə xəstələnir. Ana uşaqda dünəndən temperaturun yüksəlməsi, iştahasızlıq, halsızlıq, bağ ağrılarının olmasından şikayət edir. Bu gün səhərdən dəridə səpgilərin olduğunu görmüşdür. Temperatur 38,70dir. Uşaq halsızdır. Dəridə, xüsusiilə büküşlərdə, qasıq və qoltuqaltı nahiyələrdə xırda nöqtəvari səpgilər vardır. Ağızətrafı avazımızdır. Dil ağ ərplə örtülüb. Əsnəyi hiperemikdir. Sidik ifrazı normaldır.",
    questions: [
      {
        question: "Tibb bacısı hansı xəstəlikdən şübhələnə bilər?",
        options: ["Epidemik parotit", "Skarlatina", "Raxit"],
      ...
      {
        question: "Xəstəliyin törədicisi nədir?",
        options: ["Viruslar", "Hemolitik streptokoklar", "D vitaminin çatmamazlığı"],
        correct: 1
      },
      {
        question: "Tibb bacısı nə etməlidir?",
  ...
  {
    condition: "Ana 2 yaşlı uşağının üç gündür ki xəstələndiyini söyləyir. Onun sözünə görə uşaqda gündə 8-10 dəfə selikli nəcis ifrazı olur. Tez-tez gücənmələr və qarında sancı uşağı narahat edir. 2 dəfə qusma olub. Dünəndən halszıdır, yemək yemir. Obyektiv müayinə zamanı dəri örtükləri quru və solğundur. Dil ərplidir. Qarnt yumşaq, ağrılıdır. Nəcisi selikli qanlıdır. Temperatur 37,70dir.",
    questions: [
      {
        question: "Uşaqda hansı xəstəlik ola bilər?",
        options: ["Difteriya", "Dizenteriya", "Revmatizm"],
      ...
      {
        question: "Xəstəlik idarə olunandırmı?",
        options: ["Bəli, GDT peyvəndi ilə idarə olunur", "Xeyr, xəstəliyə qarşı peyvənd olmadığı üçün idarə olunmur", "Bəzi hallarda idarə olunur"],
        correct: 1
      },
      {
  ...
  {
    condition: "Uşağın 6 yaşı var. Profilaktik peyvəndləri peyvənd təqviminə uyğun almışdır. Məktəbə gedir. Dünən xəstələnib. Ananın sözünə görə uşağın başının tüklü hissəsində bir neçə ədəd ağcaqanad sancmasını xatırladan səpgi olub. Bu gün səhər bədənindəki həmin səpgilərdən olduğunu görüb. Müayinə zamanı bədən temperaturu 36,7 0 dir. Aktivdir. Başın tüklü hissəsində, üzündə, bədənində və ətraflarında ağcaqanad sancmasını xatırladan papulyoz səpgilər var. Səpgilər polimorfdur. Kəskin qaşınma hiss olunur. Dili ərplidir, əsnəyi sakitdir.",
    questions: [
      {
        question: "Uşaqda hansı xəstəlik ola bilər?",
        options: ["Su çiçəyi", "Dizenteriya", "Göy öskürək"],
      ...
      {
        question: "Xəstəliyin törədicisi nədir?",
        options: ["Qida ilə əlaqədardır", "Virusdur", "b hemolitik streptokoklar"],
        correct: 1
      },
      {
        question: "Xəstəlikdə neçə gün karantin təyin olunur?",
      ...
      {
        question: "Tibb bacısı nə etməlidir?",
        options: ["Uşağa antibiotiktəyin etməlidir", "Anaya uşağın qidalanması ilə əlaqədar məsləhət verir", "Həkimə çağırış yazmalıdır. Ananı xəbərdar etməlidir ki, uşağı məktəbə aparmasın, həkmin müayinəsini gözləsin"],
        correct: 2
      },
      {
        question: "Xəstəlikdən sonra necə immunitet yaranır?",
  ...
  },
  {
    ...
    questions: [
      ...
      {
        question: "Xəstə huşunu itirərsə tibb bacısı nə etməlldir?",
        options: ["Həkim gələnə qədər 40%-li 40 ml qlükoza məhlulu vena daxilinə vurmaq üçün hazırlamalıdır", "Xəstənin aşağı ətrafını bir qədər yuxarı qaldırmalıdır", "Xəstənin arterial təyziqi və nəbzinə nəzarət etməlidir"],
        correct: 0
      },
      {
        question: "Şəkərli diabet xəstəliyinin ağırlaşmas, nə ola bilər?",
        options: ["Ətraflarda ödem", "Ətraflarm qanqrenası", "Miokard infarktı"],
        correct: 1
      }
    ]
  },
  {
    condition: "28 yaşlı xəstənin sağrı əzələsinə antibiotik vurulduqdan sonra xəstədə narahatlıq, baş gicəllənmə, sinədə sıxılma hissi, arterial təyziqin enməsi, taxikardiya baş verib, xəstə huşunu itirərək yıxılıb.",
    questions: [
      {
        question: "Xəstədə hansı vəziyyətdir?",
        options: ["Hipotpniya", "Bayılma", "Anafilaktik şok"],
        correct: 2
      },
      {
        question: "Tibb bacısının taktikası:",
      ...
      {
        question: "Xəstədə ürək və tənəffüs dayanarsa, tibb bacısı nə etməlidir?",
        options: ["Xəstəyə oksigen verməlidir", "Ürəyin qapalı masajı başlanmalıdır", "Xəstəyə naşatır spirti iyləməlidir"],
        correct: 1
      },
      {
        question: "İlk yardım zamanı bu preparatlardan hansı effektlidir?",
        options: ["Platifillin, atropin, no-şpa", "Kardiamin, mezaton, analqin", "Adrenalin, prednizolon, dimedrol"],
        correct: 2
      }
    ]
  },
  {
    condition: "Stasionarda ürəyin işemik xəstəliyindən müalicə olunan 55yaşlı artıq çəkili xəstə gecə tibb bacısını çağırır. Xəstəni döş qəfəsindəki olan, sol qola vuran, sıxıcı xarakterli ağrılar və döş qəfəsindəki sıxılma hissi narahat edir. Xəstənin arterial qan təzyiqi 130/80 mm c.süt Nəbzi tezləşmişdir.",
    questions: [
      {
        question: "Xəstənin vəziyyətini müəyyənləşdirin:",
        options: ["Nevrotik hal", "Stenokardıya", "Qabırğaarası nevralgiya"],
        correct: 1
      },
      {
        question: "Tibb bacısı ilk yardım zamanı nə etməlidir?",
        options: ["Xəstəni sakitiəşdirib, təmiz hava gəlməsini təmin etməlidir, dərhal həkim çağırmalıdır", "Valokordin 25 damcı verməli və əzələ daxilinə diabzol vurmalıdır", "Vena daxilinə prednizolon vurmalıdır"],
        correct: 0
      },
      {
        question: "Xəstəiiyin yaranmasına hansı risk faktorları təsir edir?",
        options: ["Çoxlu maye qəbulu", "Piyiənmə, stres, siqaret", "Oturaq həyat tərzi"],
        correct: 1
      },
      {
        question: "İlk yardım zamanı xəstəyə hansı preparatları vermək məqsədəuyğundur?",
        options: ["Spazmalqon, baralqin", "Diklofenak, analqin", "Nıtroqlıserin, aspirin"],
        correct: 2
      },
      {
        question: "Xəstə qidalanmasında nəyi azaltmalıdır?",
        options: ["Yağlar və karbohidratlar", "Meyvə və tərəvəzləri", "Zülal qidaları"],
        correct: 0
      }
    ]
  },
  {
    condition: "Qonşuda 50 yaşlı qadın stress keçirdikdən sonra ənsə nahiyəsindəki güclü baş ağrıları, ürəkbulanma, göz önündə qara nöqtələr olmasından şikayəti Xəstənin vəziyyəti ağırdır, oyanıqdır, üzü qızarmışdır. Xəstənin təzyiqi 160/94 n c.sut, nəbzi 1 dəqiqədə 104 vurğudur.",
    questions: [
      {
        question: "Bu hansı xəstəlik ola bilər?",
        options: ["Arterial hipertenziya", "Miqren", "Beyin şişi"],
      ...
      {
        question: "Tibb bacısı ilk yardım zamanı ne etməlidir?",
        options: ["Dərhal həkim çağırıb, arterial təyziqi ölçməlidir", "Xəstəyə üfüqi vəziyyət verməlidir", "Xəstənin alnına soyuq kompres qoymalıdır"],
        correct: 0
      },
      {
        question: "Xəstəyə nə məsləhət görərdiniz?",
      ...
      {
        question: "Bu xəstəlik hansı ağrılaşma verə bilər?",
        options: ["Pievrit, nevrosteniya", "Miokard infarktı, insult", "Aritmiya, koliaps"],
        correct: 1
      }
    ]
  },
  {
    condition: "Təcili yardım xəstəxanasının qəbul şöbəsinə 45 yaşlı xəstə daxil olub, o, fiziki gərginlikdən sonra, döş sümüyünün arxasında bütün döş qəfəsinə yayılan göynədici ağrıdan şikayət edir. Ağrılar iki saata yaxındır ki, davam edir. Validol, korvalol qəbul etsə də təsiri olmayıb. Baxış zamanı xəstənin vəziyyətinin ağır, çox oyanıq, dəri örtüyünün solğun və tər damcıları ilə örtülməsi, A/T -110/70 mm c.su nəbzin 1 dəqiqədə təxminən 106 vurğu və aritmik olması müəyyənləşdirilb.",
    questions: [
      {
        question: "Bu hansı xəstəlik ola bilər?",
        options: ["Stenokardiya", "Miokard infarktı", "Quru plevrit"],
      ...
      {
        question: "Tibb bacısı ilk yardım zamanı nə etməlidir?",
        options: ["Xəstəyə nitroqliserin dil altına və aspirin verməlidir, həkim çağırmalıdır", "Xəstənin ayağına isti vanna etməlidir", "Xəstəyə analqin və dimedrol vurmalıdır"],
        correct: 0
      },
      {
        question: "Bu xəstəliklərin yaranma səbəbləri:",
        options: ["Soyuqiama, kəskin respirator xəstəliklər", "Tromboflebit", "Tac damarların daralması (spazması) və trombla tutulması"],
        correct: 2
      },
      {
        question: "Bu xəstəliklərin risk faktorları hansılardır?",
  ...
  {
    condition: "53 yaşlı kişi gecə yarısı amblotora müraciət edib. Döş qəfəsi arxasında ağrı, yangı hissiyyatı, qusma, qusmadan sonra qıcqırma olub. 20 ildir tütün qəbul edir.",
    questions: [
      {
        question: "Hansı xəstəlikdən şübhələnirsiniz?",
      ...
      {
        question: "Həkimə gələnə qədər tibb bacısı nə etməlidir?",
      ...
      },
      {
        ...
        options: ["EKQ", "Döş qəfəsi rentgen", "Ultrasəs"],
        correct: 0
      },
      {
        question: "Xəstəliyin yaranma səbəbi?",
        options: ["Apendisit", "Ezafogit reflüks", "Mədə xorası"],
        correct: 1
      },
      {
  ...
  {
    condition: "Xəstə kişidir və 2 ildir xəstədir, halhazırda ürəkbulanma, diareya, qarında qəbulundan sonra spastik ağrılardan şikayət edir ağrılar acı qidanın əmələ gəlib, defekasiya aktı zamanı artır. AT 100-60, nəbz 100. Nəcis suludur.",
    questions: [
      {
        question: "Nədən şübhələnmək olar?",
        options: ["Xroniki qastrit", "Xroniki xolesistin", "Xroniki enteritin kəskinləşməsi"],
        correct: 2
      },
      {
        question: "Hansı dərmanlardan ilk yardım olaraq istifadə edərdiniz?",
        options: ["Antobiotiklər", "Ağrıkəsicilər spazmolitiklər", "Kortikosteroidlər"],
        correct: 1
      },
      {
        question: "Xəstə hansı həkimə göndərilməlidir?",
      ...
      {
        question: "Müalicədə hansı dərmanlardan istifadə edilir?",
        options: ["Proliftikal, enteral", "Qələviləşdirən", "Kortikosteroidlər"],
        correct: 0
      },
      {
        question: "Pəhriz necə olmalıdır?",
        options: ["Qıcıqlandırıcı qidalar çıxarılır pəhrizdən, vitaminlərla zəngin qidalar verilir", "Yağlarla zəngin", "Karbohidratlarla zəngin"],
        correct: 0
      }
    ]
  },
  {
    condition: "Covid-19 koronovirusun formaları haqqında",
    questions: [
      {
        question: "Covid-19 korono virusun orta ağır formasında TS necə olur?",
        options: ["24-30 arası", "15-20 arası", "22-25 arası"],
        correct: 2
      },
      {
        question: "Covid-19 koronovirusun orta ağır formasmda SP02 necə olur?",
        options: ["65-70 faiz arası", "93-95 faiz arası", "80-85 faiz arası"],
        correct: 2
      },
      {
        question: "Covid-19 koronovirusun orta ağır formasında ağ ciyərlərin KT-sında hansı dəyişikliklər olur?",
        options: ["5-6 sm ölçüdə 2 ədəddən çox donmuş şüşə tipli bərkimə", "3-5 sm ölçüdə 3 ədəddən çox donmuş şüşə tipli bərkimə", "KT müayinəsi edilmir"],
        correct: 1
      },
      {
        question: "Covid-19 koronovirusun orta ağır formasında tempurator necə olur?",
        options: ["Febril", "Subfebril", "Olmur"],
        correct: 0
      },
      {
        question: "Covid-19 koronovirusun yüngül formasında tempurator necə olur?",
        options: ["Febril olur", "Ya olmur ya subfebril olur", "Həmişə yüksək olur"],
        correct: 1
      }
    ]
  },
  {
    ...
    questions: [
      {
        question: "Nədən şübhələnirsiniz?",
        options: ["Mədə xorası", "Qastrid", "Xroniki qastrit"],
        correct: 0
      },
      {
        question: "Xəstəyə daxilə dərman vermək olarmı?",
        options: ["Bəli", "Xeyr", "Bəzən olar"],
        correct: 1
      },
      {
        question: "Qarın üstü (epiqastral) nahiyəyə hansını qoymaq olar?",
        options: ["Buz qovuğu", "İsitqac", "Xardal yaxması"],
        correct: 0
      },
      {
        question: "Xəstənin rejimi necə olmalıdır?",
      ...
      {
        question: "Tibb bacısının taktikası:",
        options: ["Ev şəraitində müalicə", "Təcili yardım maşını ilə tez bir zaman xəstəxanaya çatdırmaq", "Həkimi çağırmaq"],
        correct: 1
      }
    ]
  },
  {
    condition: "Xəstə 19 yaşlı kişidir. Ümumi zəiflik, baş ağrısı, təngnəfəslik və bəlğəmli öskürəkdən şikayətlənir. Xəstəliyini soyuqdəymə ilə əlaqələndirir. 4 gündür xəstədir. Obvekiv olaraq vəziyyəti kafidir. Bədən temperaturu 37,70 C, tənəffüsün sayı dəqiqədə 21, A/T110/70 mm c. sül, nəbzi 1 daq. 88 vurğudur.",
    questions: [
      {
        question: "Nədən şübhələnirsiniz?",
        options: ["Pnevmaniya", "Kəskin bronxit", "Ağciyər amfizeması"],
        correct: 1
      },
      {
        question: "Xəstənin döş qəfəsinə banka qoymaq qoymaq olarmı?",
        options: ["Bəli", "Xeyr", "Bəzən olar"],
        correct: 1
      },
      {
        question: "Evkalipt dəmləməsi ilə inhalyasiya aparmaq:",
        options: ["Olar", "Olmaz", "Qadağandır"],
        correct: 0
      },
      {
        question: "Xəstənin ayaqlarını xardal vannasına qoymaq olarmı?",
        options: ["Bəli", "Xeyr", "Həkim icazəsi ilə"],
        correct: 0
      },
      {
        question: "Xəstənin rejimi necə olmalıdır?",
  ...
  {
    condition: "Uşağın 1,5 yaşı var. Ananın dediyinə görə 2 gündür xəstədir. Bədən temperaturu 39,0°, ümumi zəiflik, təngnəfəslik tez-tez təkrarlanan yaş öskürək müşahidə edilir. Tənəffüsün 1 dəqiqəlik sayı 45 dir. Ağız-burun üçbucağında sianoz nəzərə çarpır.",
    questions: [
      {
        question: "Tibb bacısı hansı xəstəlikdən şübhələnə bilər?",
        options: ["Pnevmoniya", "Anemiya", "Revmatiz"],
        correct: 0
      },
      {
        question: "Uşağa hansı yardımı göstərə bilərsiniz?",
      ...
      {
        question: "Milli Peyvənd təqviminə görə uşaq neçə dəfə bu xəstəliyə görə immunlaşdırılmalıdır?",
        options: ["5dəfə", "1 dəfə", "3 dəfə"],
        correct: 2
      }
    ]
  },
  {
    condition: "20 yaşlı oğlan xəstəxanaya gəlib. Xəstənin sol qolunda barmağı sağ əlindəki 3-4 barmağı don vurub. Şişkin qızartı. Dəri altı maye yığılıb.",
    questions: [
      {
        question: "Neçənci dərəcəli donmadı?",
        options: ["1 ci dərəcəli donma", "2 ci dərəcəli donma", "3 cü dərəcəli donma"],
      ...
      {
        question: "Həmin don vurmuş nahiyyədə hissiyyatın hansı forması saxlanılır?",
        options: ["Ağrı, temperatur", "Toxunada incidir", "Heçbiri"],
        correct: 0
      },
      {
        question: "Həmin nahiyyəyə 2-cili infeksiya qoşulmayıbsa neçə müddətə sağalarlar?",
        options: ["1 ay", "2 həftə", "2 ay"],
        correct: 1
      },
      {
      ...
      {
        question: "Ümumiyyətlə donmalarda yardım nə etmək lazımdı?",
        options: ["Buzlu su ilə ovusdurmaq", "38-40 (dərəcə) isti suya salmaq", "Quru əllə ovmaq"],
        correct: 1
      }
    ]
  },
  {
    condition: "35 yaşlı kişidə döş qəfəsinin açıq yarası vardır. Xəstənin vəziyyəti ağırdır. Boğulma və tənəffüsün çətinləşməsi qeyd olunur. Obyektiv olaraq dəri avazımız, soyuq tərlə örtülmüşdür. Üzdə və dodaqlarda sianoz vardır. Az bir vaxtda tənəffüs tezləşir, A\\T enir, taxikardiya müşahidə olunur. Nəfəsalma zamanı havanın spesifik səslə ötürülməsi, öskürüdükdə yaradan qan və hava qabarcıqları çıxması nəzərə çarpır.",
    questions: [
      {
        question: "Xəstədə nə baş vermişdir?",
        options: ["Açıq pnevmotoraks", "Plevrit", "Hemotoraks"],
        correct: 0
      },
      {
        question: "Yaranın ilkin işlənməsi necə aparılır?",
        options: ["Aseptik məhlullarla", "Su ilə yuyulur", "Yod ilə işlənir"],
        correct: 0
      },
      {
        question: "Hansı sargıdan istifadə olunur?",
        options: ["Ləçəkvan", "Okkluzion", "Adi sarğı"],
        correct: 1
      },
      {
        question: "Tibb bacısının taktikası necə olmalıdır?",
        options: ["Yara üzərinə kip sarğı qoyaraq qospitalizə olunur", "Ağrıkəsici vuraraq qospitalizə olunur", "Evdə saxlayır"],
        correct: 0
      },
      {
        question: "Xəstə hansı şöbəyə yerləşdirilir?",
        options: ["Travmotologiya", "Ümumi cərrahivvə", "Pulmonologiya"],
        correct: 0
      }
    ]
  },
  {
    condition: "Laboratoriyada elmi tədqiqat işləri ilə məşğul olan gənc qızın sol əlindəki qələvi məhlulun təsirindən dərinin kəskin qızarması, göynədici ağrılar qeyd olunur.",
    questions: [
      {
        question: "Nədən şübhələnirsiz?",
        options: ["Termiki yanıq", "Kimyəvi yanıq", "Mexaniki yara"],
        correct: 1
      },
      {
        question: "İlk yardım necə olmalıdır?",
        options: ["Yanıq səthini axar su altında 15-20 dəqiqə yuyulur", "Yanıq səthinə yanıq əleyhinə maz sürtülür", "Yanıq yerinə buz qoyulur"],
        correct: 0
      },
      {
        question: "Yaranın işlənməsindəki hansı taktika seçilir?",
        options: ["Yanıq səthini qələvi məhlulla neytrallaşdırılır", "Yanıq səthini turşu məhlulu ilə neytrallaşdırılır", "Yanıq yerinə antibiotik məlhəm sürtülür"],
        correct: 1
      },
      {
        question: "Tibb bacısı hansı məsləhəti verə bilər?",
        options: ["Quru aseptik sarğı qoyub cərraha göndərilir", "Yod çəkərək nəzarətdə saxlayır", "Spirtli kompres qoyulur"],
        correct: 0
      },
      {
        question: "Müalicə zamanı yara hansı vəziyyətdə olmalıdır?",
        options: ["Açıq qalmalıdır", "Sarğı qoyulmalıdır", "Buz qoyulmalıdır"],
        correct: 0
      }
    ]
  },
  {
    ...
    questions: [
      ...
      {
        question: "Bu vəziyyət hansı xəstəlik nəticəsindəki baş verə bilər?",
        options: ["Mədə xərçəngi", "Vərəm", "Qaraciyər serrozu"],
        correct: 1
      },
      {
        question: "Xəstə hansı şöbəyə qospitalizə oluna bilər?",
  ...
  },
  {
    ...
    questions: [
      {
        question: "Bu nədir?",
        options: ["Termiki yanıq", "Kimyəvi yanıq", "İşıq yanığı"],
        correct: 0
      },
      {
        question: "Xəstənin vəziyyəti necə olmalıdır?",
        options: ["Yarım oturaq vəziyyət", "Uzanmış vəziyyət", "Oturaq vəziyyət"],
        correct: 0
      }
    ]
  },
  {
    condition: "Pasiyentin 57 yaşı var. Hipertoniyalı xəstə qəflətən boğulma, təngnəfəslik, öskürək, çəhrayı köpüklü bəlğəm ifrazından şikayət edir. A/t 200/110 mm cs, nəbz 120.",
    questions: [
      {
        question: "Xəstədə hansı vəziyyətdir?",
        options: ["Ürək astması", "Tənəffüs çatmamazlıq", "Hipertonik kriz"],
        correct: 0
      },
      {
        question: "Tibb bacısı dərhal nə etməlidir?",
        options: ["Xəstəni üfüqi vəziyyətdə uzatmaq", "Həkim çağırmaq", "Dərman təyin etmək"],
        correct: 1
      },
      {
        question: "Bu xəstəyə təxirəsalınmaz yardım zamanı ilk atılacaq addım nədir?",
        options: ["Morfinin tətbiqi", "Xəstəni oturmuş vəziyyətə gətirmək", "Antibiotiklərin təyin edilməsi"],
        correct: 1
      },
      {
        question: "Tibb bacısı oksigen terapiyası zamanı hansı növ cihazdan istifadə etməlidir?",
        options: ["Aspirator", "Nebulizator", "Oksigen maskası"],
        correct: 2
      },
      {
        question: "Hansı preparatlar xəstəyə təyin edilə bilər?",
        options: ["Atropin, adrenalin", "Laziks, strofantin", "Kontrikal, festal"],
        correct: 1
      }
    ]
  ...
  {
    condition: "Ana 2 yaşlı uşağının üç gündür ki xəstələndiyini söyləyir. Onun sözünə görə uşaqda gündə 8-10 dəfə selikli nəcis ifrazı olur. Tez-tez gücənmələr və qarında sancı olur. 2 dəfə qusma olub. Dünəndən, halsızdır, yemək yemir. Obyektiv müayinə zamanı dəri örtükləri quru və solğundur. Dil ərplidir. Qarnı yumşaq, ağrılıdır. Nəcisi selikli qanlıdır. Temperatur 37,70dir.",
    questions: [
      {
        question: "Uşaqda hansı xəstəlik ola bilər?",
        options: ["Difteriya", "Dizenteriya", "Revmatizm"],
      ...
      {
        question: "Hansı imalə olunur?",
        options: ["Dərman imaləsi", "Sifon imaləsi", "Çobanyastığı dəmləməsi ilə mikro imalə"],
        correct: 0
      },
      {
        question: "Tibb bacısı nə etməlidir?",
      ...
      {
        question: "Xəstəyə içməyə nə verilir?",
        options: ["Az-az çoxlu maye vermək", "Heçnə verməmək", "Çox miqdarda maye birdən vermək"],
        correct: 0
      }
    ]
  },
  {
    condition: "48 yaşlı xəstə gecələr və ac qaldıqda epiqastral nahiyədə olan dözülməz ağrıdan, hava gəyirmədən, ürəkbulanma, qusma və zəiflikdən şikayət edir, 1,5 ildir ki, xəstəlik davam edir, son 5 gün ərzindəki vəziyyəti daha da pisləşib. Xəstə bunu stress keçirməsi ilə əlaqələndirir. Obyektiv olaraq xəstənin vəziyyəti kafidir, huşu aydındır, dəri ilə əlaqələndirir. Obyektiv olaraq xəstənin vəziyyəti kafidir, huşu aydındır, dəri örtüyü solğun, A/T -7 00/60 mm c.sut, nəbz 1 dəqiqədə 64 vurğudur.",
    questions: [
      {
        question: "Bu hansı xəstəlikdir?",
        options: ["12-barmaq bağırsağın xora xəstəliyi", "Pankreatit", "Xroniki qastrit"],
      ...
      {
        question: "Bu xəstəlikdə hansı diaqnostik müayinələr aparılır?",
        options: ["Ultrasəs müayinəsi", "Endoskopik müayinə, biopsiya", "Elektrokardiografiya"],
        correct: 1
      },
      {
        question: "Xəstəliyin ağırlaşması:",
      ...
      {
        question: "Ağrıları sakitləşdirmək üçün xəstəyə hansı preparatlar təyin edilə bilər?",
        options: ["Almagel pankreatin", "Kontrikal, festal", "Platifilin, no-şpa"],
        correct: 2
      }
    ]
  },
  {
    condition: "55 yaşlı xəstə ağızda quruluq, yangı hissi, çoxlu maye və qida qəbul etməsi, arıqlama, görmə zəifliyi, ayaqlarda hissiyyatın itməsi və tez yorulma şikayətləri ilə həkimə müraciət edib. Obyektiv olaraq xəstənin vəziyyəti orta ağırdır, dəri qurudur, üzərindəki qaşınma izləri var. A/T140/90 mm c.sut, nəbz 1 dəqiqədə 80-dir.",
    questions: [
      {
        question: "Bu hansı xəstəlikdir?",
        options: ["Miksedema", "Şəkərsiz diabet", "Şəkərli diabet"],
      ...
      {
        question: "Xəstə hansı müayinələrdən keçməlidir?",
        options: ["Ultrasəs müayinəsi", "Mədə şirəsinin müayinəsi", "Qanda və sidikdə şəkərin daimi müayinəsi"],
        correct: 2
      },
      {
        question: "Xəstəliyin müalicəsindəki hansı preparatlar təyin edilə bilər?",
        options: ["Desmopressin", "İnsulin", "Levo-tiroksin"],
        correct: 1
      }
    ]
  ...
  {
    condition: "18 yaşlı gənc imtahan verərkən qəflətən huşunu itirir və yıxılır. Obyekiiv olaraq xəstənin dəri örtüyü' solğundur, soyuq tərlə örtülüb. Tənəffüsü 1 dəqiqədə 16-dır. A/T- 90/60 mm c.sut, nəbz 1 dəqiqədə 100 vurğudur.",
    questions: [
      {
        question: "Bu əlamətlər hansı xəstəlikdə ola bilər?",
        options: ["Bayılma", "Epilepsiya", "Hipoqlikemiya"],
      ...
      {
        question: "Xəstəyə bu vəziyyətin yaranma səbəbini izah edin.",
        options: ["Beyində qısa müddətli oksigen çatmamazlığı (Hipoksiya)", "Beyində patoloji ocağın olması", "Qanda tiroksinin normadan aşağı olması"],
        correct: 0
      },
      {
        question: "Tibb bacısının taktikası:",
        options: ["Xəstənin beyninə qan gəlməsi üçün ayaqlara hündür vəziyyət verməlidir", "Qusma zamanı xəstənin başını yana çevirməlidir", "Xəstəyə atropin əzələ daxilinə vurulmalıdır"],
        correct: 0
      },
      {
        question: "Bu vəziyyət nə qədər davam edə bilər?",
  ...
  {
    condition: "12 yaşlı oğlan uşağı valideyni ilə səhər acqarnına qan analizi vermək üçün tibb müəssisəsinə müraciət edib. Manipulyasiya zamanı uşağın vəziyyəti qəfil pisləşdi, rəngi avazıdı və huşunu itirdi. Tibb bacısı təcili həkimə məlumat verdi. Həkim müayinədən sonra xəstəyə dərialtıma kofein təyin etdi. A/T - 85/55 mm c. süt.",
    questions: [
      {
        question: "Xəstədə nə baş vermişdir?",
        options: ["Bayılma", "Anafilaktik şok", "Qıcolma"],
      ...
      {
        question: "Həkim xəstəyə kofein benzoat inyeksiyası təyin edib. Kofein hans nahiyəyə və neçə dərəcəli bucaq altında vurulmalıdır?",
        options: ["Bazunun aşağı 1/3 hissəsinə 90 dərəcə bucaq altında", "Bazunun yuxarı 1/3 hissəsinə 90 dərəcə bucaq altında", "Bazunun yuxarı 1/3 hissəsinə 45 dərəcə bucaq altında"],
        correct: 2
      },
      {
  ...
  {
    condition: "Ana 10 günlük uşaği ilə poliklinikaya müraciət edib. Doğularkən uşağın çəkisi 3500 qramm, boyu 52 sm olub. Uşaq təbii qidalanır. Ananın dediyinə görə uşaq bir neçə gündür döşdən imtina edir. Narahatdır. Yuxusu pozulub. Teztez oyanır. Gün ərzindəki defekasiya aktı bir dəfə müşahidə olunur. Obyektiv müayinədəki qarnda köp nəzərə çarpır. Temperatur 36,60C-dır. Həkim uşağa qazçıxarıcı boru və imalə təyin edib.",
    questions: [
      {
        question: "Tibb bacısı qazçıxarıcı borunu düz bağırsaqda nə qədər saxlamalıdır?",
        options: ["3-5dəq", "30dəq", "1 saat"],
        correct: 0
      },
      {
        question: "İmalə üçün tibb bacısı suyu hansı temperaturda götürməlidir?",
      ...
      {
        question: "Tibb bacısı imalə üçün nə qədər su götürməlidir?",
        options: ["50 ml/kq (200 ml)", "30ml/kq(120ml)", "10 ml/kq (40 ml)"],
        correct: 2
      },
      {
        question: "İmalə zamanı yenidoğulmuş uşaq hansı vəziyyətdə ola bilər?",
        options: ["Sol böyrü üstə və Kürəyi üstə (1.2)", "2.3", "Yalnız 4"],
        correct: 0
      },
      {
        question: "Tibb bacısı anaya hansı məsləhəti verə bilər?",
        options: ["Uşağı adaptasiyə olunmuş qidalarla qidalandırmaq", "Köp.və qəbzlik yaradan qidaları qida rasionundan çıxarmaq", "Uşağı döşdən ayırmaq"],
        correct: 1
      }
    ]
  },
  {
    condition: "Xəstənin sol qolundaki əlindəki 1 barmağı sağ əlindəki 3-4 barmağı don vurub. Şişkin qızartı. Dəri altı maye yığılıb.",
    questions: [
      {
        question: "Neçənci dərəcəli donmadı?",
        options: ["1 ci dərəcəli donma", "2 ci dərəcəli donma", "3 cü dərəcəli donma"],
      ...
      {
        question: "Donmadan neçə müddət sonra demarkasion xətt əmələ gəlir?",
        options: ["10-12gün", "25-30gün", "4-6saat"],
        correct: 0
      },
      {
        question: "Don vurmuş nahiyyənin qan dövranını bərpa etmək üçün hansı ilk tibbi yardım göstərilir?",
        options: ["Spirtli pampıqla sürtmək", "Quru əllə sürtmək", "Yodla silmək"],
        correct: 0
      },
      {
        question: "Demarkasion xətt hansı toxumalar arasmda əmələ gəlir?",
        options: ["Dəri ilə Sağlam toxuma arasında", "Sağlam toxuma ilə ölmüş toxuma arasında", "Əzələ ilə dəri arasında"],
        correct: 1
      }
    ]
  },
  {
    condition: "Tibb bacısı 5 yaşlı uşağa patronaja gedib. Uşaq 6 gündür xəstədir. Səpkilər var. Səpgilər bədənin müəyyən nahiyələrdə birləşib. Dildə və ağız boşluğundaki bela səpkilərin olduğu görünür. Qızdırması var. Ana uşaqda səpkilərin 4-cü gündən çıxdığını söyləyir. Uşaq halsızdır.",
    questions: [
      {
        question: "Hans xəstəlikdən şübhələnmək olar?",
        options: ["Qızılca", "Skarlatina", "Su çiçəyi"],
        correct: 0
      },
      {
        question: "Xəstəliyin törədicisi nədir?",
        options: ["Virusdur", "Qida ilə əlaqədardır", "B hemolitik streptokoklar"],
        correct: 0
      },
      {
        question: "Xəstəlikdə neçə gün karantin təyin olunur?",
      ...
      {
        question: "Tibb bacısı nə etməlidir?",
        options: ["Uşağa antibiotik təyin etməlidir", "Anaya uşağın qidalanması ilə əlaqədar məsləhət verilir", "Həkimə çağırış yazmalıdır. Ananı xəbərdar etməlidir ki, uşağı məktəbə aparmasın, həkmin müayinəsini gözləsin"],
        correct: 2
      },
      {
        question: "Xəstəlikdən sonra necə immunitet yaranır?",
  ...
  {
    condition: "Ana 6 yaşlı qız uşağı ilə quru öskürək, iştahasızlıq, dəridə səpgilər, temperaturun yüksəlməsi şikayətləri ilə həkimə müraciət edib. Uşaq 2900 q çəki, 49 sm boyla vaxtında doğulmuşdur. Anamnezindəki tez-tez KRVİ yoluxmalar qeyd olunur. Ana profilaktik peyvəndlərdən imtina edib. Biryaşa qədər heç bir infeksion xəstəlik keçirməmişdir. Uşaq məktəbə gedir. Dünən xəstələnib. Ananın sözünə görə 15 gün əvvəl məktəbə gedən qardaşında da belə səpgilər olmuşdur. Obyektiv müayinə zamanı uşağın tempuratoru normaldır. Üzündə, bədənindəki və ətraflarda xırda papulyoz çəhrayı səpgilər var. Ənsə limfa vəzilərini əllənir, ağrısızdır. Ağız boşluğunun selili qişası təmizdir, əsnək bir qədər hiperemikdir. Həkimin tapşırığı ilə tibb bacısı anaya xəstəyə qulluq haqqında məlumat verməlidir.",
    questions: [
      {
        question: "Uşaqda hansı xəstəlik ola bilər?",
        options: ["Su çiçəyi", "Məxmərək", "Angina"],
      ...
      {
        question: "Əllənən limfatik düyünlərin üzərinə yod və ya spirt tərkibli kompres qoymaq məsləhətdirmi?",
        options: ["Spirt tərkibli kompres qoymaq lazımdır", "Bəli, yod setkası mütləq çəkilməlidir", "Xeyr, limfatik vəzilər sağalma dövründə sorularaq sağalır"],
        correct: 2
      },
      {
  ...
  {
    condition: "Tibb bacısı 5 aylıq uşağa patronaja gedib. Uşaq birinci hamiləlikdəndir. Hamiləlik və doğuş normal keçmişdir. Doğularkən çəkisi 3000 qr, boyu 51 sm olmuşdur. Ana südü ilə qidalanır. Ananın narahatlığından, yuxusunun pis olmasından, yuxuda və döşlə qidalanan zaman çox tərləməsindən, tez-tez diksinməsindən şikayət edir.",
    questions: [
      {
        question: "Uşaqda hansı xəstəlik ola bilər?",
        options: ["Pnevmoniya", "Raxit", "Revmatizm"],
      ...
      {
        question: "Tibb bacısının anaya məsləhəti nə ola bilər?",
        options: ["Uşağı açıq havada gəzdirməli, həkimin təyinatına riayət etməli, meyvə - tərəvəz şirələri verməsini məsləhət görməlidir", "Uşağı evdə saxlamaq, yalnız süd qarışıqları ilə qidalandırmaq", "Uşaqı saat 12.00-16.00 arasında günün altında saxlamalıdır"],
        correct: 0
      },
      {
        question: "Raxit diaqnozu qoyulmuş uşaq profilaktik peyvəndlərini almalıdırmı?",
        options: ["Bəli, Raxit xəstəliyi profilaktik peyvəndlərin aparılması üçün əks göstəriş deyil", "Xeyr, peyvənd aparmaq olmaz", "Raxit xəstəliyi zamanı uşağa yalnız canlı vaksinlər vurmaq olar"],
        correct: 0
      },
      {
        question: "Günorta, saat 12.00-16.00 dək, uşağı havaya çıxarmaq məsləhətdirmi?",
  ...
  },
  {
    ...
    questions: [
      ...
      {
        question: "Bu vaksin uşağı hansı xəstəlikdən qoruyur?",
        options: ["Qızılca, Parotit, Məxmərək", "Vərəm, Difteriya, Su çiçəyi", "Polimielit, Difteriya"],
        correct: 0
      },
      {
        question: "Vaksinindən sonra uşaqda hansı immunitet formalaşır?",
        options: ["Süni aktiv", "Süni passiv", "Təbii aktiv"],
        correct: 0
      },
      {
        question: "Bu vaksinlə yanaşı uşağa hansı vitamin verilməlidir?",
      ...
      {
        question: "Bu vaksin hansı temperaturda saxlanılmalıdır?",
        options: ["(+2 dərəcə) - (+8 dərəcə)", "(0 dərəcə) - (+12 dərəcə)", "(+3 dərəcə)-(+10 dərəcə)"],
        correct: 0
      }
    ]
  },
  {
    condition: "Uşaq 3 aylıqdır. 3000 q çəkidə doğulub. Süni qidalanır. Hazırda 5100 qrmdır. Müayinə zamanı qasıq və sarğı büküşlərindəki hiperimiya qeyd olunur.",
    questions: [
      {
        question: "Uşağın çəkisi necə olmalıdır?",
      ...
      {
        question: "Hiperemiyanın səbəbi nədir?",
        options: ["Gigiyena qaydalarını gözləməmək", "Allergiya", "Məxmərək"],
        correct: 0
      },
      {
        question: "Belə hiperemiya nə adlanır?",
      ...
      {
        question: "Tibb bacısının taktikası?",
        options: ["Həkim çağırmaq", "Müalicə etmək", "Aşağı çimizdirmək"],
        correct: 0
      },
      {
        question: "Tibb bacısının anaya məsləhəti?",
        options: ["Gigiyenik qaydalara nəzarət", "Pəhriz", "İsti saxlamaq"],
        correct: 0
      }
    ]
  },
  {
    condition: "Ana uşağı peyvəndə gətirib. Uşağın büküşlərindəki qızartı və səpgi var.",
    questions: [
      {
        question: "Bu nədir?",
        options: ["Bişməcə", "Diatez", "Hemonqioma"],
        correct: 0
      },
      {
        question: "Xəstəliyin səbəbi nədir?",
        options: ["Ferment çatışmamazlığı", "Gigiyenik qaydalar gözlənilməyib", "İsti saxlamaq"],
        correct: 1
      },
      {
        question: "Peyvənd vurmaq olarmı?",
        options: ["Mütləq olmalıdır", "Olmaz", "Olar"],
        correct: 2
      },
      {
        question: "Sizin anaya məsləhətiniz:",
        options: ["Gigiyenik qaydaları gözləmək", "Təmiz havada gəzdirmək", "İsti saxlamaq"],
        correct: 0
      },
      {
        question: "Pəhrizdə nə olmalıdır?",
        options: ["Dietik yemeklər", "Sitrus meyvələri", "İstənilən yemək"],
        correct: 0
      }
    ]
  },
  {
    condition: "64 yaşlı kişi son günlər sidik ifrazının çətinləşməsindən, ağrılı olmasından şikayətlənir. Xəstə sidik ifrazı hissi olması baxmayaraq sidiyin gec ifraz olmasında, sidik təziqinin azalmasından, sonda damcı sidik ifrazından şikayət edir.",
    questions: [
      {
        question: "Nədən şübhələnirsiniz?",
        options: ["Prostatın adenoması", "Sistit", "Pretonit"],
  ...
  {
    condition: "17 yaşlı xəstə diz və dirsək oynağında olan ucuçu xarakterli ağrıdan, ürək nahiyəsində xoşagəlməz hissdən, ümumi zəiflik və iştahasızlıqdan şıkayət edir. İki həftə əvvəl angina ilə xəstələndiyini söyləyir. Baxış zamanı xəstənin narahat olduğu, oynaqlannm şişkin və ağrılı olması, temperaturun 37,8, A/T 110/70, nəbzinin 85 vurğu olması müəyyənləşib.",
    questions: [
      {
        question: "Bu hansı xəstəlik ola bilər?",
        options: ["Revmatizm", "KRVİ", "Salmonelyoz"],
      ...
      {
        question: "Müalicə necə aparılır?",
        options: ["Ayda bir dəfə", "Sxemlə", "Gündə birdəfə"],
        correct: 1
      },
      {
        question: "Oynağa nə qoyulur?",
        options: ["Sipirt", "Soyuq", "İsitqac"],
        correct: 2
      },
      {
        question: "Gələcəkdə hansı fəsadlar ola bilər?",
  ...
  {
    condition: "Vaksinator səhər işə gələrkən vaksinlərsaxlanılan soyuducunun -2' C olduğunu müəyyən edib.",
    questions: [
      {
        question: "Belə vəziyyətdə vaksinator tibb bacısı nə etməlidir?",
        options: ["Donma şübhəsi olan vaksinlər üçün 'silkələnmə testi' aparmalı", "Vaksinlər dərhal məhv edilməlidir", "Vaksinləri istifadə etməlidir"],
        correct: 0
      },
      {
        question: "Donmaya həssas vaksinlər hansılardır?",
        options: ["GDT: QPM Q", "GDT, DT Q", "OPV: QPM"],
        correct: 1
      },
      {
        question: "Donmayan vaksinlər soyuducunun hansı rəfindəki saxlanılır?",
        options: ["Aşağı rəfdə", "Orta rədə", "Soyuducunun qapısında"],
        correct: 1
      },
      {
      ...
      {
        question: "Yararsız vaksin flakoniar necə məhv edilir?",
        options: ["Müvafiq qaydalara uyğun olaraq məhv edilir", "Zibil qutusuna atılır", "Flakonlar sındırılaraq atılır"],
        correct: 0
      }
    ]
  },
  {
    ...
    questions: [
      ...
      {
        question: "Diaqnoz hansı üsulla təsdiq oiuna bilər?",
        options: ["Rentgen", "Ultrasəs müayinə", "Biopsiya"],
        correct: 1
      },
      {
        question: "Xəstə hansı həkimə göndərili r?",
        options: ["Proktologa", "Urologa", "Qastroenteroloqa"],
        correct: 1
      }
    ]
  },
  {
    condition: "Yenidoğulmuş uşaq narahatdır. Döşdən imtina edir. Qarında köp var.",
    questions: [
      {
        question: "Bu nədir?",
        options: ["Dispepsiya", "Dizinteriya", "Metiorizm"],
      ...
      {
        question: "İlk yardım necə olunmalıdır?",
        options: ["İmalə", "Təmiz havaya çıxartmaq", "İsti vanna"],
        correct: 0
      },
      {
        question: "İmalə üçün nə qədər su lazım?",
        options: ["10 ml/kq", "100ml/kq", "50 ml/kq"],
        correct: 0
      },
      {
        question: "Qazçıxarıcı borunu nə qədər saxlayırlar?",
        options: ["10-15dəq", "20-25 dəq", "3-5dəq"],
        correct: 2
      },
      {
        question: "İmalə hansı vəziyyətdə qoyulmalıdır?",
  ...
  {
    condition: "Ana 10 günlük uşağı ilə poliklinikaya gəlib. Uşaq təbii qidalanır. 2 gündür narahatdır. Çətinliklə qidalanır. Temperatur normaldır, yuxusu pozulub, tez-tez oyanır. Gün ərzindəki 1 dəfə nəcis ifraz edib. Qarnında köp var.",
    questions: [
      {
        question: "Nədən şübhələnirsiniz?",
        options: ["Qəbizlik", "Bağırsaq keçməməzliyi", "Meteoriz"],
        correct: 2
      },
      {
        question: "İlk yardım nədir?",
        options: ["İmalə", "İstiqac", "Soyuq"],
        correct: 0
      },
      {
        question: "İmalə üçün suyun temperaturu neçə olmalıdır?",
        options: ["35-37", "37-39", "40-41"],
        correct: 0
      },
      {
        question: "Qazçıxarcı boru hansı dərinliyə yeridilməlidir?",
        options: ["2sm", "5 sm", "7sm"],
        correct: 0
      },
      {
        question: "Qarın hansı istiqamətdə masaj edilməlidir?",
        options: ["Saat əqrəbi istiqamətindəki", "Aşağıdan yuxarı", "Yuxarıdan aşağı"],
        correct: 0
      }
    ]
  },
  {
    condition: "Tibb bacısı patronaj zamanı təbii qidalanan 9 aylıq uşaqda 38-39 temperatur, ətrafları isti, selikli qişaları qurudur. Uşağın dəri örtüyü al qırmızıdır. Huşu aydındır.",
    questions: [
      {
        question: "Müşahidə edilən hal hərarətin hansı stadiyasıdır?",
        options: ["Febril", "Subfebril", "Heç biri"],
      ...
      {
        question: "Tibb bacısının taktikası necə olmalıdır?",
        options: ["Həkimi çağırmaq", "Məsləhət vermək", "Söhbət etmək"],
        correct: 0
      },
      {
        question: "İlk yardım olaraq iri damarlara nə qoymaq olar?",
        options: ["Xardal", "İsitqac", "Buz"],
        correct: 2
      },
      {
        question: "Hansı inyeksiyanı etmək olar?",
  ...
  {
    condition: "Hadisə yerindəki evdəki ağacın altında yerdə uzanmış orta yaşlı kişi boğazında kəkin, bir qədər kənarları şişkinləşmiş ilə müşahidə olunan qızartı var. Onun huşu aydtn deyil bəbəkləri genişlənmiş, yuxarı və aşağı ətraf əzələlərindəki tonusun artması müşahidə olunur. Xəstənin sifətindəki şişkinlik, üz dərisindəki tündləşmə, göz altında qaraima qeyd olunur.",
    questions: [
      {
        question: "Nədən şübhələnirsiniz?",
        options: ["Bayılma", "Özünü asma", "Şok"],
      ...
      {
        question: "İlk tibbi yardım üçün nə etmək lazımdır?",
        options: ["Ürəyi qapalı masaj edib, süni tənəffüs vermək", "Ürəyi açıq masaj edib, süni tənəffüs vermək", "Heçnə etməmək"],
        correct: 0
      },
      {
        question: "Kliniki ölümlə bioloji ölümü necə müəyyənləşdirək?",
        options: ["Gözün işığa qarşı reaksiyası ilə", "Nəbzin olub-olmaması ilə", "Tənəffüsün olub-olmaması ilə"],
        correct: 0
      },
      {
        question: "Kliniki ölümdə və bioioji ölümdə orqanizmdəki gedən prosesin fərqli cəhəti?",
        options: ["Fərqi yoxdur", "Kliniki ölümdə beynin dekortikasiyası baş verir", "Bioloji ölümdə beynin dekortikasiyası baş verir"],
        correct: 2
      },
      {
        question: "Kliniki ölüm nə qədər davam edir?",
        options: ["5-6 dəq", "10-20 dəq", "15-25dəq"],
        correct: 0
      }
    ]
  },
  {
    condition: "18 aylıq uşağı ilə poliklinikaya peyvənd olunmaq üçün müraciət edib. Bu vaxta kimi uşaq təqvimə əsasən bütün peyvənləri alıb. Uşaqda 37,5C öskürək burun axması aşkar olunur.",
    questions: [
      {
        question: "Tibb bacısı nədən şübhələnir?",
        options: ["Göyöskürək", "KRVİ", "Məxmərək"],
        correct: 1
      },
      {
        question: "Peyvənd hansı halda vurulmalıdır?",
        options: ["Uşaq sağaldıqdan minimum 2 həftə sonra", "Uşaq sağaldıqdan 1 həftə sonra", "Uşaq tam sağalmamış"],
        correct: 0
      },
      {
        question: "Peyvənd təqviminə əsasən hansı peyvənd vurulmalıdır?",
        options: ["QPM", "DT", "GDT, OPV"],
        correct: 2
      },
      {
        question: "OPV vaksini uşağa necə verilir?",
        options: ["Peroral", "Əzələdaxili", "Dərialtı"],
        correct: 0
      },
      {
        question: "QDT peyvəndi hansı yaşda vurulmalıdır?",
        options: ["12ayhğında", "18 aylığında", "2 yaşında"],
        correct: 1
      }
    ]
  },
  {
    condition: "50 yaşlı xəstə iştahamn azalması dəri qaşınması qarnın böyüməsi, bu səbəbdən təngnəfəslik, ayaqlarda ağrıdan şikayət edir. Son 3 ildə periodik olaraq dəri örtüklərindəki sarılıq, sidiyin saralması olmuş vəözünə keçmişdir. Xəstənin çəkisi nəzərə çarpacaq qədər azdır, əlləri əsir, döş qəfəsindəki və kürəkdə damar ulduzcuqları vardır.",
    questions: [
      {
        question: "Bunlar hansı xəstəliyin əlamətləri ola bilər?",
        options: ["Ağciyər xərçəngi", "Qaraciyər sirrozu", "Mədə xorası"],
        correct: 1
      },
      {
        question: "Qarnın böyüməsini tibbi terminlə necə istifadə edilir?",
        options: ["Assit", "Sistit", "Mastit"],
        correct: 0
      },
      {
        question: "Qaraciyər sirrozu olan xəstə hansı yemakdən imtina etməlidir?",
        options: ["Kefir, qatıq", "Qızardılmış ət", "Buxarda bişmiş balıq"],
        correct: 1
      },
      {
        question: "Tibb bacısı nə etməlidir?",
        options: ["Xəstəni müayinə edir", "Həkim təyinatına tibb bacısı cidli nəzarət edir", "Xəstəyə dərman təyin edir"],
        correct: 1
      },
      {
        question: "Bu xəstəliyin hansı müalicə üsulu vardır?",
        options: ["Rentgen müayinə", "Qastrofibroskopiya", "Qarın boşluğunun punksiyası"],
        correct: 2
      }
    ]
  },
  {
    condition: "66 yaşlı kişi pasiyent, diabet diaqnozu ilə illlərdir müşahidədədir. O, tibb məntəqəsinə sağ ayağında yaranın yaranması və sağ ayaq barmağında qaralma şikayətləri ilə sağ ayağında müraciət edir. Pasiyent qeyd edir ki, yaranı əvvəlcə ciddi qəbul etməyib, lakin son bir həftə ərzindəki yara ətrafında qızartı, şişkinlik və ağrı artıb.",
    questions: [
      {
        question: "Pasiyentin nekroz əlamətlərindən biri hansıdır?",
        options: ["Sağ ayaqda periferik nəbzin güclənməsi", "Sağ ayaq barmaqlarında qaralma", "Qan şəkəri səviyyəsinin azalması"],
        correct: 1
      },
      {
        question: "Nekrozun yaranmasının əsas səbəbi nə ola bilər?",
        options: ["Qan dövranının pozulması", "Şəkərinin aşağı olması", "Ayağın çox istirahət etməsi"],
        correct: 0
      },
      {
        question: "Tibb bacısının bu vəziyyətdəki ilk növbədə etməli olduğu iş nədir?",
        options: ["Pasiyentin qidalanma planını dəyişdirmək", "Yaraya baxış keçirərək gigiyenik tədbirlər görmək", "Pasiyentə fiziki məşq təklif etmək"],
        correct: 1
      },
      {
        question: "Pasiyentə ayaq baxımı ilə bağlı hansı tövsiyə verilməlidir?",
        options: ["Ayaqların isti su ilə tez-tez yuyulması", "Ayaqların hər gün müayinə edilməsi və yaraların vaxtında müalicəsi", "Ayaqlarda yaranan hər hansı dəyişiklikləri gözardı etmək"],
        correct: 1
      },
      {
        question: "Nekrozun qarşısını almaq üçün diabetli pasiyentlər üçün ən vacib profilaktik tədbir hansıdır?",
        options: ["Çox miqdarda maye qəbul etmək", "Ayaq baxımına diqqət etmək və qan şəkərini normada saxlamaq", "Ayaqları daim isti saxlamaq"],
        correct: 1
      }
    ]
  },
  {
    condition: "50 yaşlı kişinin qarnında sancı şəklindəki tutmalarla ağrılar, ağrıların əvvəlcə məhəlli (lokal) olmasına baxmayaraq sonradan yayılmış ağrılara keçməsi müşahidə olunur. Ağrılar tez-tez təkrarlanır, ara-sıra qusma müşahidə olunur, lakin yüngülləşmə hiss olunmur. Bəzən qusuntu kütləsindən nəcis iyi gəlir. Defekasiya və qazların ləngiməsi müşahidə olunur. Xəstanin rəngi avazımış və soyuq tərlə örtülmüşdür. Dil quru və qəhvəyi rəngli ərplə örtülmüşdür, ağızdan pis iy gəlir.",
    questions: [
      {
        question: "Nədən şübhələnirsiniz?",
        options: ["Bağırsaq keçməməzliyindən", "Xroniki apendisitdən", "Böyrək daşı xəstəliyindən"],
      ...
      {
        question: "İlkin görüləcək tədbirlər nədən ibarətdir?",
        options: ["Xəstəyə rahatlıq verib, təcili yardıma zəng etmək", "Ağrıkəsici, narkotiklər vurmaq", "İmalə etmək"],
        correct: 0
      },
      {
        question: "Sizin ilk addımınız necə olmalıdır?",
      ...
      {
        question: "Belə xəstəyə hansı müayinələr mütləq aparılmalıdır?",
        options: ["Rentgen müayinəsi və qastroskopiya (FQDS)", "Artroskopiya", "Laparosentez"],
        correct: 0
      },
      {
        question: "Xəstənin daşınması necə həyata keçirilir?",
  ...
  {
    condition: "Uşaq 3700 q çəki, 52 sm boy ilə doğulmuşdur. Apqar şkalası ilə 8 balla qiymətləndirilmişdir. Doğum evindəki müvafiq peyvəndləri almışdır. Bir yaşadək 3 dəfə Pentaksim və OPV ilə vaksinlənmişdir. Pnevmokok əleyhinə vaksin almamışdır. Hazırda 2 yaşı var.",
    questions: [
      {
        question: "Pnevmokok əleyhinə vaksinin vurulmasına uşağın hansı yaş dövründən başlanılır?",
        options: ["2 ayından", "2 yaşından", "1 yaşından"],
        correct: 0
      },
      {
        question: "Pk vaksini hansı nahiyəyə və necə yeridilir?",
        options: ["Budun ön-lateral hissəsinə, əzələ daxilinə, 900C dərəcə bucaq altında", "Sağrının yuxarı xarici 1/4 kvadrantına, əzələ daxilinə, 450C dərəcə bucaq altında", "Bazunun lateral hissəsinə, əzələ daxilinə, 30-450C dərəcə bucaq altında"],
        correct: 0
      },
      {
        question: "Pk vaksini neçə dəfə vurulur?",
        options: ["3 dəfə", "1 dəfə", "2 dəfə"],
        correct: 0
      },
      {
        question: "Pk vaksini tərkibinə görə necə vaksindir?",
        options: ["Cansız", "Canlı", "Gen mühəndisliyi ilə hazırlanmış"],
        correct: 0
      },
      {
        question: "Pk vaksini uşağı hansı xəstəlikdəm qoruyur?",
        options: ["Pnevmoniya", "Polimielit", "Difteriya"],
        correct: 0
      }
    ]
  },
  {
    condition: "Poliklinikanın peyvənd otağında yerləşən soyuducunun işi elektrik naqillərindəki nasazlığa görə 4 saat ərzindəki dayanmışdır. Soyuducuda 24 ədəd müxtəlif tipli peyvənd flakonu var. Soyuducunun orta rəfindəki yerləşdirilən termometr +10 dərəcə C göstərir.",
    questions: [
      {
        question: "Peyvəndlər hansı temperatur rejimindəki saxlanılmalıdır?",
        options: ["(+2 dərəcə)-(+8 dərəcə)", "(+10 dərəcə)-(+15 dərəcə)", "(-2 dərəcə)-(-4 dərəcə)"],
        correct: 0
      },
      {
        question: "Peyvənd otağının vaksin edən tibb bacısı vaksinlər saxlanılan soyuducunun temperatur göstəricisini gündə neçə dəfə yoxlamalıdır?",
        options: ["2 dəfə", "1 dəfə", "3 dəfə"],
        correct: 0
      },
      {
        question: "Soyuducunun işi 4 saat dayandığı halda soyuducuda olan vaksinləri istifadə etmək olarmı?",
      ...
      {
        question: "Soyuducuda qalan vaksinləri nə etmək lazımdır?",
        options: ["Məhv etmək", "Saxlamaq", "Tez istifadə etmək"],
        correct: 0
      },
      {
        question: "Yarasız vaksin flakonları necə məhv edilir?",
        options: ["Müvafiq qaydalara uyğun olaraq məhv edilir", "Zibil qutusuna atılrs", "Flakonlar sındırılaraq atılır"],
        correct: 0
      }
    ]
  },
  {
    condition: "26 yaşlı gənc oğlanda bazunun yuxarı 1/3 – də palpasiya zamanı və hərəkət etdirdikdə, ağrılar müşahidə edilir. Palpasiya zamanı krepitasiya hiss olunur. Ətrafın funkisyası pozulmuşdur. Xəstənin vəziyyəti ağırdır, dəri örtüyü soyuq tərlə örtülmüşdür.",
    questions: [
      {
        question: "Nədən şübhələnirsiniz?",
        options: ["Bazunun qapalı sınığı", "Bazunun çıxığı", "Yumşaq toxumaların əzilməsi"],
        correct: 0
      },
      {
        question: "İlkin görüləcək tədbirlər?",
        options: ["Xəstəyə rahatlıq vermək və paltarlarını çıxartmamaq", "Paltarlarını çıxartmaq", "Repozisiya etmək"],
        correct: 0
      },
      {
        question: "İlk tibbi yardım nədən ibarətdir?",
      ...
      {
        question: "Mütləq müayinə hansıdır?",
        options: ["Rentgenoloji müayinə", "USM(ultura səs müayinəsi)", "Dopler müayinə"],
        correct: 0
      },
      {
        question: "Ağrını azaltmaq üçün nə etmək lazımdır?",
        options: ["2%-li 2-5 ml novokain blokadası etmək", "Kompleks vitamin terapiyası", "Antibiotiklərdən istifadə etmək"],
        correct: 0
      }
    ]
  },
  {
    condition: "52 yaşlı arıq bədənli kişidə sürəkli öskürəkdən sonra qısa müddət ərzindəki 10 ml- dən çox al-qırmızı köpüklü qan xaric olur.",
    questions: [
      {
        question: "Nədən şübhələnirsiniz?",
        options: ["Ağ ciyər qanaxmasından", "Mədə qanaxmasından", "Onikibarmaq bağırsaq qanaxmasından"],
      ...
      {
        question: "Görüləcək ilk tədbir nədən ibarətdir?",
        options: ["Xəstəyə rahatlıq verib təcili yardıma zəng etmək", "Xəstəyə 5%-li qlükoza məhlulu venaya köçürtmək", "Heparin inyeksiyasını vurmaq"],
        correct: 0
      },
      {
        question: "İlk tibbi yardım necə olmalıdır?",
        options: ["Venadaxilinə 10%-li 10ml kalsium xlor", "İsitqac qoymaq", "Oksigen inhalyasiyasını aparmaq"],
        correct: 0
      },
      {
        question: "Diaqnozu təsdiq etmək üçün aparılacaq əsas müayinə üsulu hansıdır?",
      ...
      {
        question: "Xəstə hansı şöbədə yerləşdirilməlidir?",
        options: ["Vərəm şöbəsindəki (və ya pulmonologiya şöbəsindəki)", "Terapiya şöbəsindəki", "Travmatologiya şöbəsindəki"],
        correct: 0
      }
    ]
  },
  {
    condition: "Qəbul şöbəsinə gətirilən 62 yaşlı qadın yağlı qida qəbulundan sonra sağ qabırğaaltı nahiyədəki olan, sağ kürəyə və çiyinə vuran güclü ağrıdan, vaxtaşırı öd qusmadan, ağızda quruluq və acılıq hissindən şikayətlənir. Xəstənin vəziyyəti orta ağırdır, bədən temperaturu 36,60C və A/T -130/80 mm c.sut, nəbzin 1 dəqiqədə 90 vurğudur.",
    questions: [
      {
        question: "Hansı xəstəlikdən şübhələnirsiniz?",
        options: ["Xolesistit", "Appendisit", "Pankreatit"],
      ...
      {
        question: "Tibb bacısı qusma zamanı hansı yardım göstərməlidir?",
        options: ["Qusma zamanı xəstənin başını yana çevirməlidir", "Sağ qabırğaaltı nahiyəyə soyuq kompress qoymalıdır", "Epiqastral nahiyəyə buz qovuğu qoymalıdır"],
        correct: 0
      },
      {
        question: "Bu xəstəlik zamanı hansı müayinələr aparıla bilər?",
        options: ["Qarın boşluğu üzvlərinin ultrasəs müayinəsi", "Endoskopik müayinə", "Rentgenoloji müayinə"],
        correct: 0
      },
      {
        question: "Xəstənin mədəsini yumaq üçün həkimin nəzarəti ilə hansı tədbir həyata keçirilməlidir?",
        options: ["Xəstənin mədəsini yumaq", "Xəstəyə çoxlu maye vermək", "Fibroqastroduodenoskopiya"],
        correct: 0
      },
      {
        question: "Mədəni yumaq üçün nə qədər maye götürülür?",
        options: ["10 litr", "5 litr", "1 litr"],
        correct: 0
      }
    ]
  },
  {
    condition: "18 yaşlı gənc imtahan verərkən qəflətən huşunu itirir və yıxılır. Obyektiv olaraq xəstənin dəri örtüyü solğundur, soyuq tərlə örtülüb. Tənəffüsü 1 dəqiqədəki 16-dır. A/T- 90/60 mm c.sut, nəbz 1 dəqiqədə 100 vurğudur.",
    questions: [
      {
        question: "Bu əlamətlər hansı xəstəlikdə ola bilər?",
        options: ["Bayılma", "Epilepsiya", "Hipoqlikemiya"],
  ...
  {
    condition: "Tibb bacısı 14 günlük uşağa patronaja gedib. Uşaq təbii qidalanır. Ana göbək yarasının nəm olmasından şikayət edir. Obyektiv müayinə zamam göbəkdən serozlu ifrazatın axması müəyyən olunur. Uşağın temperaturu 37,800 dir. Ümumi vəziyyəti qənaətbəxşdir.",
    questions: [
      {
        question: "Hansı xəstəlikdən şübhələnmək olar?",
        options: ["Kataral omfalit", "Hemolitik anemiya", "Yenidoğulmuşun qovuqcuqlu xəstəliyi"],
        correct: 0
      },
      {
        question: "Tibb bacısı hansı taktikanı seçməlidir?",
      ...
      {
        question: "Xəstədə göbək yarasına yerli olaraq nə istifadə oluna bilər?",
        options: ["3% hidrogen-peroksid, 70 % spirt və brilyant əbısı", "1 % tetrasiklin mazı", "Kalium permanqanat"],
        correct: 0
      },
      {
        question: "Tibb bacısı anaya uşaqda bu vəziyyətin hansı səbəbdən yarandığını necə izah etməlidir?",
  ...
  },
  {
    ...
    questions: [
      ...
      {
        question: "Xəstədə bu vəziyyətin yaranma səbəbini izah edin.",
        options: ["Qorxu hissi, həyacan", "Kəskin qastrit", "Revmatizm"],
        correct: 0
      },
      {
        question: "Həkim gələnə kimi tibb bacısı xəstəyə hansı vəziyyəti verməlidir?",
      ...
      {
        question: "Həkim xəstəyə kofein benzoat inyeksiyası təyin edib. Kofein hansı nahiyəyə və neçə dərəcəli bucaq altında vurulmalıdır?",
        options: ["Bazunun yuxarı 1/3 hissəsinə 45° dərəcə bucaq altında", "Bazunun yuxarı 1/3 hissəsinə 90° dərəcə bucaq altında", "Bazunun aşağı 1/3 hissəsinə 90° dərəcə bucaq altında"],
        correct: 0
      },
      {
        question: "Uşaq ayıldıqdan sonra tibb bacısı nə etməlidir?",
        options: ["Şərbət vermək", "Xardal qoymaq", "Ayaqlarını vanna etmək"],
        correct: 0
      }
    ]
  },
  {
    condition: "Ana 10 günlük uşağı ilə poliklinikaya müraciət edib. Doğularkən uşağın çəkisi 3500 qramm, boyu 52 sm olub. Uşaq təbii qidalanır. Ananın dediyinə görə uşaq bir neçə gündür döşdən imtina edir. Narahatdır. Yuxusu pozulub. Tez tez oyanır. Gün ərzindəki defekasiya aktı bir dəfə müşahidə olunur. Obyektiv müayinədəki qarnda köp nəzərə çarpır. Temperatur 36,60C-dır. Həkim uşağa qazçıxarıcı boru və imalə təyin edib.",
    questions: [
      {
        question: "Tibb bacısı qazçıxarıcı borunu düz bağırsaqda nə qədər saxlamalıdır?",
        options: ["3-5dəq", "30 dəq", "1 saat"],
        correct: 0
      },
      {
        question: "İmalə üçün tibb bacısı suyu hansı temperaturda götürməlidir?",
        options: ["35-37 dərəcə", "10-12 dərəcə", "20-22 dərəcə"],
        correct: 0
      },
      {
        question: "Tibb bacısı imalə üçün nə qədər su götürməlidir?",
        options: ["10 ml/kq (40 ml)", "50 ml/kq (200 ml)", "30ml/kq(120ml)"],
        correct: 0
      },
      {
        question: "İmalə zamanı yenidoğulmuş uşaq hansı vəziyyətdə ola bilər?",
        options: ["Sol böyrü üstə, Kürəyi üstə (1.2)", "2.3", "Yalnız 4"],
        correct: 0
      },
      {
        question: "Tibb bacısı anaya hansı məsləhəti verə bilər?",
        options: ["Köp.və qəbzlik yaradan qidaları qida rasionundan çıxarmaq", "Uşağı adaptasiyə olunmuş qidalarla qidalandırmaq", "Uşağı döşdən ayırmaq"],
        correct: 0
      }
    ]
  },
  {
    condition: "Doğum evindəki 30 həftəlik hamiləlikdən çəkisi 1600q, boyu 42 sm olan uşaq doğulmuşdur. Ana HBsAg (Hepatit B) daşıyıcısıdır.",
    questions: [
      {
        question: "Tibb bacısı yenidoğulmuş uşağı necə xarakterizə edə bilər?",
        options: ["Vaxtından əvvəl doğulmuş uşaq", "Sağlam yenidoğulmuş uşaq", "Vaxtınan gec doğulan uşaq"],
        correct: 0
      },
      {
        question: "Bu uşağın sonrakı qulluq qaydası necə olmalıdır?",
        options: ["Uşağı küvezdə saxlamaq", "Evə yazmaq", "İsti mələfəyə bükub, süni qidalarla qidalandırmaq"],
        correct: 0
      },
      {
        question: "Əgər uşaq küvezdə saxlanılsa, hansı temperatur rejimi seçilməlidir?",
      ...
      {
        question: "Doğulduqdan sonra ilk 1saat ərzindəki bu uşaq döşə qoyula bilərmi?",
        options: ["Xeyr, uşağın vəziyyəti bərpa olunduqdan sonra döşə qoyula bilər", "Bəli, bu uşaq ilk 1 saat ərzindəki döşə qoyula bilər", "Bu uşağa döş vermək əks göstərişdir"],
        correct: 0
      },
      {
        question: "Həkim uşağa Hepatit B peyvəndinin vurulmasını təyin edib. Hepatit B peyvəndi hansı nahiyəyə vurulmalıdır?",
  ...
  {
    condition: "Ana 6 aylıq uşağı ilə peyvənd olunmaq üçün poliklinikaya gəlib. Uşağın doğularkən çəkisi 3000q, boyu 52 sm olmuşdur. Hal hazırda çəkisi 7650 q, boyu 68 sm-dir. Müayinə zamanı sağrı və qasıq büküşlərindəki hiperemiya (qızartı) qeyd olunur. Uşaq qarışıq qidalanır.",
    questions: [
      {
        question: "Uşağın çəkisi antropometrik göstəricilərə görə fiziki inkişafa uyğundurmu?",
        options: ["Bəli, uyğundur", "Xeyr, uyğun deyil", "Uşağın çəkisi fiziki inkişaf meyarlarına aid deyil"],
      ...
      {
        question: "Tibb bacısı anaya hiperemiyanın səbəbini necə izah edə bilər?",
        options: ["Uşağın isti saxlanılması və gigiyenik qaydalara riayət olunmaması", "Uşağın süni qidalandırılması", "Uşağın təbii qidalandırılması"],
        correct: 0
      },
      {
        question: "Pentaksim (Hib) hansı vaksinlərə aiddir?",
      ...
      {
        question: "Pentaksim neçə vaksinin kombinasiyasıdır?",
        options: ["5", "3", "1"],
        correct: 0
      }
    ]
  ...
  {
    condition: "Ana 2 aylıq oğlan uşağı ilə poliklinikaya müraciət etmişdir. Ananın dediyinə görə uşağa 1 gün əvvəl Pentaksim (GDTHibHepB) vaksinin ilk dozası vurulmuşdur. Günün sonuna doğru uşağın temperaturu 39,80C-yə yüksəlmiş, uşaq 2 saat ərzindəki fasiləsiz olaraq ağlamışdır. Obyektiv olaraq uşağın temperaturu hal-hazırda 38,70C-dir. Dərisi solğundur, süstlük nəzərə çarpır. Tənəffüs və ürək döyüntülərinin dəqiqəlik sayı artmışdır. Vaksinin yeridildiyi nahiyədəki hiperemiya və 5 sm diametrindəki infiltrat qeyd olunur.",
    questions: [
      {
        question: "Pentaksim (Hib) hansı vaksinlərə aiddir?",
        options: ["Cansız", "Canlı", "Gen mühəndisliyi ilə hazırlanmış"],
      ...
      {
        question: "Pentaksim vaksinin vurulmasına uşağın neçə ayından başlamaq lazımdır?",
        options: ["2 ayından", "6 ayından", "4-7-ci gündən"],
        correct: 0
      }
    ]
  ...
  {
    condition: "Uşaq 1900 q çəki ilə doğulmuşdur. Vaxtından əvvəl doğulmuşlar üçün küvezə yerləşdirilmişdir. İlk 12 saat ərzindəki Hepatit B əleyhinə vaksin almışdır. Neonatoloq tərəfindən vərəm əleyhinə peyvəndin doğum evindəki vurulmasına əks-göstəriş qeyd edilmişdir. Hal hazırda uşaq 2,5 aylıqdır, çəkisi 3400 q-dır. Ümumi vəziyyəti kafidir.",
    questions: [
      {
        question: "Hal hazırda uşağa BCG (vərəm əleyhinə) vaksini vurmaq olarmı?",
        options: ["Vurmaq olar, lakin Mantu sınağı qoyulduqdan sonra", "Bəli, sınaq qoymadan vurmaq olar", "Xeyr, vurmaq olmaz"],
      ...
      {
        question: "BCG vaksini orqanizmin hansı nahiyəsinə və necə yeridilir?",
        options: ["Bazu nahiyyəsinə, sol çiyindən 2 sm aşağı, dərriiçi", "Budun ön-lateral nahiyyəsinə əzələdaxili, 900C bucaq altında", "Sağrı əzələsinə, əzələdaxili, 900C bucaq altında"],
        correct: 0
      },
      {
        question: "BCG vaksini yeridildikdən sonra ilk immun reaksiya nə vaxt əmələ gəlir?",
        options: ["8 həftəyə", "1 həftəyə", "10 günə"],
        correct: 0
      },
      {
        question: "2,5 aylıq uşağa BCG vaksini yeridilməmişdən əvvəl Mantu sınağı qoyulmalıdırmı?",
        options: ["Bəli, mütləq qoyulmalıdır", "Xeyr, qoyulmur", "Mantu sınağı 1 yaşdan sonra qoyula bilər"],
        correct: 0
      }
    ]
  },
  {
    condition: "Xəstə qadındır, 41 yaşı var. Döş sümüyü arxasındaki sıxıcı, təzyiq edici ağrılardan, ağrının sol qola, sol çiyinə yayılmasından, başgicəllənmədən şikayət edir. Ağrılar 5-ci mərtəbəyə ağır zənbillə piyada qalxandan sonra başlayıb. Əvvəllər də ürək nahiyəsindəki qısa müddətli ağrılar olub, lakin əhəmiyyət verməyib, həkimə müraciət etməyib. Nitroqliserin qəbulundan sonra ağrılar keçib. Obyektiv olaraq vəziyyəti kafidir, dərialtı piy təbəqəsi qalındır. Tənəffüsün sayı 1 dəqiqədə 16, nəbz-92, A/T - 130/90 mm c.süt, t0 - 36,70C-dir.",
    questions: [
      {
        question: "Nədən şübhələnirsiniz?",
        options: ["Stenokardiya", "Ürək astması", "Miokard infarktı"],
      ...
      {
        question: "Ürək nahiyəsinə hansını qoymaq məqsədəuyğundur?",
        options: ["Xardal yaxması", "Banka", "Soyuq kompress"],
        correct: 2
      },
      {
        question: "Belə vəziyyətdə xəstəyə hansı dərman kömək edir?",
        options: ["Nitroqliserin", "Analgin", "Noşpa"],
        correct: 0
      },
      {
        question: "Xəstə hansı vəziyyətdə olmalıdır?",
        options: ["Yarım oturaq", "Arxası üstə uzanmış", "Ayaqları bir qədər yuxarı olmaqla uzanmış"],
        correct: 0
      },
      {
        question: "Tibb bacısının sonrakı taktikası:",
  ...
  },
  {
    ...
    questions: [
      {
        question: "Nədən şübhələnirsiniz?",
        options: ["Hipertonik kriz", "Burun qanaxması", "Anemiya"],
        correct: 0
      },
      {
        question: "Xəstəyə yardım göstərərkən hansını etmək olmaz?",
      ...
      {
        question: "Xəstənin vəziyyəti necə olmalıdır?",
        options: ["Yarım oturaq", "Arxası üstə uzanmış vəziyyət", "Sol tərəfi üstə uzanmış vəziyyət"],
        correct: 0
      },
      {
        question: "Tibb bacısının sonrakı taktikası necə olmalıdır?",
        options: ["Təcili yardım çağırmaq", "Xəstəni terapevtin qəbuluna göndərmək", "Xəstəyə yuxugətirici dərman preparatı təyin etmək"],
        correct: 0
      }
    ]
  },
  {
    condition: "19 yaşı xəstənin yüksək temperatur, diz, topuq, dirsək oynaqlarında ağrı şikayətləri var. Bir gün əvvəl qəflətən temperaturu 39 dərəcə C-yə yüksəlmiş və oynaqları ağrımağa başlamışdır. Anamnezindəki 2 həftə əvvəl angina keçirdiyini söyləyir. Obyektiv olaraq vəziyyəti orta ağırdır, bədən temperaturu 390C-dir. Diz oynağı nahiyəsindəki şişkinlik, qızartı, hərəkət zamanı ağrı müşahidə olunur. Nəbz 1 dəqiqədə 115, A/T – 110/70 mm c.süt. Ağız boşluğunda kariyesli dişlər, badamcıqların böyüdüyü görünür.",
    questions: [
      {
        question: "Nədən şübhələnirsiniz?",
        options: ["Revmatoid artrit", "Artroz", "Hemorragik vaskulit"],
      ...
      {
        question: "Diz oynağına nə etmək olar?",
        options: ["İsidici kompres", "Buz qovuğu", "Xardal yaxması"],
        correct: 0
      },
      {
        question: "Qizdırmanı aşağı salmaq üçün nə etmək olar?",
        options: ["Xəstənin alnına soyuq kompres qoymaq", "Bədənini 40 dərəcəli su ilə silmək", "Bədənini bürümək"],
        correct: 0
      },
      {
        question: "Xəstəyə steroid preparatları necə vermək lazımdır?",
  ...
  {
    condition: "Ananın sözlərinə görə 5 yaşlı uşaq gecəni narahat yatır, ağzından su axır, anus dəliyi ətrafındaki qaşınma, göbək ətrafındaki ağrılar, ümumi narahatlıq hissi, iştahasızlıq müşahidə olunur. Obyektiv olaraq çəki itkisi, dəri örtüklərinin solğunluğu, anus dəliyi ətrafındaki ekzematoz zədələnmələr nəzərə çarpır. Sahə həkimi ümumi müayinədən sonra tibb bacısına anaya tövsiyələrinivermēyi və anus dəliyindən yaxma götürmək üçün uşağı hazırlamaq qaydalarını öyrətməyi tapşırdı.",
    questions: [
      {
        question: "Hansı xəstəlikdən şübhələnmək olar?",
        options: ["Enterebioz", "Qastrit", "Xolesistit"],
        correct: 0
      },
      {
        question: "Tibb bacısı anaya hansı məsləhəti verə bilər?",
        options: ["Sanitar-gigiyenik qaydalara riayət etsin", "Uşağın qidasındaki yağların miqdarını artırsın", "Vitamin C qəbul etsin"],
        correct: 0
      },
      {
        question: "Anus dəliyindən yaxma necə götürülür?",
        options: ["Səhər, anus dəliyi yuyulmamış", "Axşam yatmazdan əvvəl", "Səhər yeməkdən sonra"],
        correct: 0
      },
      {
        question: "Helmintozlar zamanı bütün ailə üzvlərini müayinə etməyə ehtiyac varmı?",
      ...
      {
        question: "Helmintoz diaqnozu təsdiq edilmiş uşaqlar uşaq müəssisəsinə gedə bilərmi?",
        options: ["Gedə bilər", "Karantin elan edilməlidir", "Xəstəxanada müalicə olunmalıdır"],
        correct: 0
      }
    ]
  },
  {
    condition: "Ana 10 yaşlı uşağı ilə poliklinikaya müraciət edib. Uşaq ürək nahiyyəsindəki ağrılar, ağırlıq hissi, tez yorulma, təngnəfəslik, iri oynaqlarda uçucu xarakter daşıyan ağrılardan şikayət edir. Anamnezdə ildə 4-5 dəfə yüksək temperaturla müşayiət olunan angina qeyd olunur. Obyektiv olaraq uşaqda süstlük, dəri örtüklərinin avazıması, oynaq ətrafındaki şişkinlik, xırda səpgilər müşahidə edilir. Temperatur 37,80C dir. UDS (ürək döyüntülərinin dəqiqəlik sayı) 80, TS (tənəffüsün dəqiqəlik sayı) 21 dir. Müayinədən sonra həkim müalicə təyin edib və tibb bacısına Bisillin terapiyasını aparmağı tapşırıb.",
    questions: [
      {
        question: "Hansı xəstəlikdən şübhələnmək olar?",
        options: ["Revmatizm", "Helmintoz", "Qastrit"],
        correct: 0
      },
      {
        question: "Həkim gələnə qədər tibb bacısı nə etməlidir?",
      ...
      {
        question: "Bisillin-5-in vurulma qaydası necədir?",
        options: ["İlboyu, isti aylar istisna olmaqla, əzələdaxili, ayda bir dəfə", "Günaşırı, 2 həftə ərzindəki", "8 həftə, həftədə 1dəfə"],
        correct: 0
      },
      {
        question: "Bədən temperaturu 37,8 0C olduqda, fiziki üsullarla endirməyə ehtiyac varmı?",
        options: ["Xeyr", "Bəli", "Litik qarışıq vurmaq lazımdır"],
        correct: 0
      },
      {
        question: "Bisillin-5 hansı nahiyəyə və neçə dərəcəli bucaq altındaki vurulmalıdır?",
        options: ["Sağrı əzələsinin yuxarı xarici 1\\4 kvadratına, 90 dərəcəli bucaq altında", "Sağrı əzələsinin yuxarı daxili 1\\4 kvadratına, 90 dərəcəli bucaq altında", "Sağrı əzələsinin yuxarı xarici 1\\4 kvadratına, 45 dərəcəli bucaq altında"],
        correct: 0
      }
    ]
  },
  {
    ...
    questions: [
      {
        question: "Tibb bacısı hansı xəstəlikdən şübhələnə bilər?",
        options: ["Skarlatina", "Epidemik parotit", "Raxit"],
        correct: 0
      },
      {
        question: "Xəstəliyin törədicisi nədir?",
        options: ["b hemolitik streptokoklar", "Viruslar", "D vitaminin çatmamazlığı"],
        correct: 0
      },
      {
        question: "Tibb bacısı nə etməlidir?",
        options: ["Həkimə məlumat verməlidir", "Uşağa vitaminlər təyin etməlidir", "Uşağı müayinə etməlidir"],
        correct: 0
      },
      {
        question: "Bu xəstəliyə qarşı hansı peyvənd aparılır?",
        options: ["Bu xəstəliyə qarşı peyvənd yoxdur", "GDT", "Pk"],
        correct: 0
      },
      {
        question: "Xəstəlikdən sonra hansı fəsadlar ola bilər?",
  ...
  {
    condition: "Ana 2 yaşlı uşağının üç gündür ki xəstələndiyini söyləyir. Onun sözünə görə uşaqda gündə 8-10 dəfə selikli nəcis ifrazı olur. Tez-tez gücənmələr və qarında sancı uşağı narahat edir. 2 dəfə qusma olub. Dünəndən halszıdır, yemək yemir. Obyektiv müayinə zamanı dəri örtükləri quru və solğundur. Dil ərplidir. Qarnı yumşaq, ağrılıdır. Nəcisi selikli qanlıdır. Temperatur 37,70dir.",
    questions: [
      {
        question: "Uşaqda hansı xəstəlik ola bilər?",
        options: ["Dizenteriya", "Difteriya", "Revmatizm"],
        correct: 0
      },
      {
        question: "Bu necə xəstəlikdir?",
      ...
      {
        question: "Xəstəlik idarəolunandırmı?",
        options: ["Xeyr, xəstəliyə qarşı peyvənd olmadığı üçün idarə olunmur", "Bəli, GDT peyvəndi ilə idarə olunur", "Bəzi hallarda idarə olunur"],
        correct: 0
      },
      {
        question: "Xəstəliyə qarşı peyvənd olunurmu?",
        options: ["Xeyr, bu xəstəliyin peyvəndi yoxdur", "GDT peyvəndi ilə", "Pk peyvəndi ilə"],
        correct: 0
      }
    ]
  },
  {
    condition: "Uşağın 6 yaşı var. Profilaktik peyvəndləri peyvənd təqviminə uyğun almışdır. Məktəbə gedir. Dünən xəstələnib. Ananın sözünə görə uşağın başının tüklü hissəsindəki bir neçə ədəd ağcaqanad sancmasını xatırladan səpgi olub. Bu gün səhər bədənindəki həmin səpgilərdən olduğunu görüb. Müayinə zamanı bədən temperaturu 36,7 0 dir. Aktivdir. Başın tüklü hissəsindəki, üzündəki, bədənindəki və ətraflarındakı ağcaqanad sancmasını xatırladan papulyoz səpgilər var. Səpgilər polimorfdur. Kəskin qaşınma hiss olunur. Dili ərplidir, əsnəyi sakitdir.",
    questions: [
      {
        question: "Uşaqda hansı xəstəlik ola bilər?",
        options: ["Su çiçəyi", "Dizenteriya", "Göy öskürək"],
      ...
      {
        question: "Tibb bacısı nə etməlidir?",
        options: ["Həkimə çağırış yazmalıdır. Ananı xəbərdar etməlidir ki, uşağı məktəbə aparmasın, həkmin müayinəsini gözləsin", "Anaya uşağın qidalanması ilə əlaqədar məsləhət verir", "Uşağa antibiotik təyin etməlidir"],
        correct: 0
      },
      {
        question: "Xəstəlikdən sonra necə immunitet yaranır?",
